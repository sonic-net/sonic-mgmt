...
class DeviceNameValidator(GroupValidator):
    ...
    def _validate(self, context: ValidatorContext) -> ValidationResult:
        ...
        device_names = self._extract_device_names(conn_graph, context.get_group_name(), result)

        # Check for duplicates within the group
        self._check_duplicate_device_names(device_names, context.get_group_name(), result)

        # Validate device name format
        self._validate_device_name_format(device_names, context.get_group_name(), result)
        ...
        if result.success and device_names:
            result.add_info(
    ...
    def _extract_device_names(self, conn_graph, group_name, result):
        """
    ...
    def _check_duplicate_device_names(self, device_names, group_name, result):
        """
    ...
    def _validate_device_name_format(self, device_names, group_name, result):
        """
