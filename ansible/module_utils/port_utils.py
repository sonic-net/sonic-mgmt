...
def get_port_alias_to_name_map(hwsku, asic_name=None):
    ...
    try:
        ...
        # TODO: Come up with a generic formula for generating etp style aliases based on number of ports and lanes
        ...
        elif hwsku in ["Arista-7060X6-64DE-O128S2", "Arista-7060X6-64PE-O128",
                       "Arista-7060X6-64PE-O128S2", "Arista-7060X6-64PE-B-O128",
            ...
            if hwsku not in ["Arista-7060X6-64PE-O128", "Arista-7060X6-64PE-B-O128"]:
                port_alias_to_name_map["etp65"] = "Ethernet512"
                port_alias_to_name_map["etp66"] = "Ethernet513"
        ...
        elif hwsku in ["Nokia-IXR7250E-36x400G", "Nokia-IXR7250E-36x100G", "Nokia-IXR7250-X3B", "Arista-7280DR3AM-36"]:
            for i in range(1, 37):
                sonic_name = "Ethernet%d" % ((i - 1) * 8)
        ...
        elif hwsku in ["Cisco-8101-O32", "Cisco-8101-C32", "Cisco-8101C01-C32",
                       "Cisco-8101C01-C28S4", "Cisco-8111-C32", "Cisco-8111-O32"]:
            for i in range(0, 32):
            ...
            for i in range(20, 32):
                port_alias_to_name_map["etp%da" % i] = "Ethernet%d" % (i * 4 * 2)
                port_alias_to_name_map["etp%db" % i] = "Ethernet%d" % ((i * 4 * 2) + 4)
        elif hwsku in ["Cisco-8101-C64", "Cisco-8101-V64", "Cisco-8101C01-V64"]:
            for i in range(0, 32):
                port_alias_to_name_map["etp%da" % i] = "Ethernet%d" % (i * 4 * 2)
                port_alias_to_name_map["etp%db" % i] = "Ethernet%d" % ((i * 4 * 2) + 4)
