...
class Arista(object):
    ...
    def run(self):
            ...
            if not quit_enabled:
                ...
                if cmd == 'cpu_down':
                    ...
                    if last_lacppdu_time_before_reboot is not None:
                        self.lacp_pdu_time_on_down.append(
                ...
                if (cmd == 'cpu_going_up' or cmd == 'cpu_up') and self.collect_lacppdu_time:
                    ...
                    if last_lacppdu_time_before_reboot is not None and last_lacppdu_time_after_reboot is not None and \
                        ...
                        self.lacp_pdu_time_on_up.append(
                            last_lacppdu_time_after_reboot)
                        # post-reboot lacp-pdu is received, stop the polling
                        self.collect_lacppdu_time = False
        ...
        return self.fails, self.info, cli_data, log_data, \
            {"lacp_down": self.lacp_pdu_time_on_down, "lacp_up": self.lacp_pdu_time_on_up}
