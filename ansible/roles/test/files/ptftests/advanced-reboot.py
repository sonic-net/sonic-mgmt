...
class ReloadTest(BaseTest):
    ...
    def neigh_lag_status_check(self):
        ...
        for neigh in self.ssh_targets:
            self.test_params['port_channel_intf_idx'] = [x['ptf_ports'][0] for x in self.vm_dut_map if x['mgmt_addr'] == neigh]
    ...
    def peer_state_check(self, ip, queue):
        ...
        self.test_params['port_channel_intf_idx'] = [x['ptf_ports'][0] for x in self.vm_dut_map.values() if x['mgmt_addr'] == ip]
