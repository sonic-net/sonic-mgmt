...
class RouterUtility():
    ...
    def load_route_info(self, route_info_path):
        '''
        @summary: Load route_info file into self.route_info.
                  For details see section 'Format of the route_info file' in the summary of the class.
    ...
    def is_ipv4_address(self, ipaddr):
        ...
        is_valid_ipv4 = True
        try:
            # building ipaddress fails for some of addresses unless str(ipaddr) is specified for both ipv4/ipv6
            # Example - 192.168.156.129, it is valid IPV4 address, send_packet works with it.
            ip = ipaddress.IPv4Address(str(ipaddr))     # noqa F841
        except Exception:
            is_valid_ipv4 = False
    ...
    def is_ipv6_address(self, ipaddr):
        ...
        is_valid_ipv6 = True
        try:
            ip = ipaddress.IPv6Address(str(ipaddr))     # noqa F841
        except Exception:
            is_valid_ipv6 = False
    ...
    def verify_packet_any_port(self, pkt, ports=[], device_number=0):
        ...
        received = False
        match_index = 0
        (rcv_device, rcv_port, rcv_pkt, pkt_time) = dp_poll(self,
