...
function usage
{
  ...
  echo
  echo "To start all VMs on a server: $0 start-vms 'server-name' ~/password.txt"
  ...
  echo "To start VMs for specified topology on server: $0 start-topo-vms 'topo-name' ~/password.txt"
  echo "To stop all VMs on a server:  $0 stop-vms 'server-name' ~/password.txt"
  echo "To stop VMs for specified topology on server: $0 stop-topo-vms 'topo-name' ~/password.txt"
  echo "To deploy a topology on a server: $0 add-topo 'topo-name' ~/password.txt"
  echo "    Optional argument for add-topo:"
  echo "        -e ptf_imagetag=<tag>    # Use PTF image with specified tag for creating PTF container"
  echo "To remove a topology on a server: $0 remove-topo 'topo-name' ~/password.txt"
  echo "To renumber a topology on a server: $0 renumber-topo 'topo-name' ~/password.txt"
  echo "To connect a topology: $0 connect-topo 'topo-name' ~/password.txt"
  echo "To refresh DUT in a topology: $0 refresh-dut 'topo-name' ~/password.txt"
  echo "To configure a VM on a server: $0 config-vm 'topo-name' 'vm-name' ~/password.txt"
  echo "To generate minigraph for DUT in a topology: $0 gen-mg 'topo-name' 'inventory' ~/password.txt"
  echo "To deploy minigraph to DUT in a topology: $0 deploy-mg 'topo-name' 'inventory' ~/password.txt"
  ...
  echo "To create Kubernetes master on a server: $0 -m k8s_ubuntu create-master 'k8s-server-name'  ~/password.txt"
  echo "To destroy Kubernetes master on a server: $0 -m k8s_ubuntu destroy-master 'k8s-server-name' ~/password.txt"
  echo
