...
'
 ...
 # If according to the type of topology to define the topology information.The 
 # topo_info will be in the file of "vars/topo_${topo}.yml".If according to not
 # only the type of topology but also the dut. The topo_info will be in the file
 # of "vars/topo_${topo}_${dut}.yml".By default. Using the previous file. If the 
 # latter file exists which is needed to be generated by the user of the dut. 
 # Using the latter file.

 topo_info="vars/topo_${topo}_${dut}.yml"

 if [ ! -f "$topo_info" ];then
    topo_info="vars/topo_${topo}.yml"
 fi
...
function add_topo
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_add_vm_topology.yml --vault-password-file="${passwd}" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e ptf_ip="$ptf_ip" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name" -e ptf_imagename="$ptf_imagename" $@
...
function remove_topo
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_remove_vm_topology.yml --vault-password-file="${passwd}" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e ptf_ip="$ptf_ip" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name" -e ptf_imagename="$ptf_imagename" $@
...
function renumber_topo
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_renumber_vm_topology.yml --vault-password-file="${passwd}" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e ptf_ip="$ptf_ip" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name" -e ptf_imagename="$ptf_imagename" $@
...
function refresh_dut
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_refresh_dut.yml --vault-password-file="${passwd}" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e ptf_ip="$ptf_ip" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name" -e ptf_imagename="$ptf_imagename" $@
...
function connect_vms
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_connect_vms.yml --vault-password-file="$2" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name"
...
function disconnect_vms
{
  ...
  ANSIBLE_SCP_IF_SSH=y ansible-playbook -i $vmfile testbed_disconnect_vms.yml --vault-password-file="$2" -l "$server" -e topo_name="$topo_name" -e dut_name="$dut" -e VM_base="$vm_base" -e topo="$topo" -e topo_file="$topo_info" -e vm_set_name="$testbed_name"
...
function config_vm
{
  ...
  ansible-playbook -i $vmfile eos.yml --vault-password-file="$3" -l "$2" -e topo="$topo" -e topo_file="$topo_info" -e VM_base="$vm_base"
