...
- To add a new testbed “vms1-1-t1”:
  - ./testbed-cli add-topo vms1-1-t1 ~/password.txt

- To switch from testbed “vms1-1-t1” to testbed “vms1-1-lag”
  - ./testbed-cli remove-topo vms1-1-t1 ~/password.txt
  - ./testbed-cli add-topo vms1-1-t1-lag ~/password.txt
...
- To add a new testbed “vms2-2-b”:
  - ./testbed-cli add-topo vms2-2-b ~/password.txt

- To switch from testbed “vms2-2-b” to testbed “vms2-2-m”
  - ./testbed-cli renumber-topo vms2-2-m ~/password.txt
...
- To add a new testbed “example-ixia”:
  - ./testbed-cli add-topo example-ixia ~/password.txt

- To remove a Keysight API server docker container
  - ./testbed-cli remove-topo example-ixia ~/password.txt
