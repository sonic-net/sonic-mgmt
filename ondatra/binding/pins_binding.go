...
type pinsDUT struct {
	*binding.AbstractDUT
	bind *Binding
	grpc bindingbackend.GRPCService
}
...
func (d *pinsDUT) DialGNMI(ctx context.Context, opts ...grpc.DialOption) (gpb.GNMIClient, error) {
	...
	opts = append(opts, grpcutil.WithUnaryDefaultTimeout(defaultTimeout), grpcutil.WithStreamDefaultTimeout(defaultTimeout))
	conn, err := d.bind.DialGRPC(ctx, d.grpc.GNMIAddr, opts...)
	if err != nil {
		return nil, err
	}
...
func (d *pinsDUT) DialGNOI(ctx context.Context, opts ...grpc.DialOption) (gnoigo.Clients, error) {
	...
	opts = append(opts, grpcutil.WithUnaryDefaultTimeout(30*time.Second), grpcutil.WithStreamDefaultTimeout(2*time.Minute))
	conn, err := d.bind.DialGRPC(ctx, d.grpc.GNOIAddr, opts...)
	if err != nil {
		return nil, err
	}
...
func (d *pinsDUT) DialP4RT(ctx context.Context, opts ...grpc.DialOption) (p4pb.P4RuntimeClient, error) {
	opts = append(opts, grpcutil.WithUnaryDefaultTimeout(30*time.Second), grpcutil.WithStreamDefaultTimeout(2*time.Minute))
	conn, err := d.bind.DialGRPC(ctx, d.grpc.P4RTAddr, opts...)
	if err != nil {
		return nil, err
	}
