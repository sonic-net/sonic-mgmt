...
"""
RETURN = r"""
# content generated by the update_return_section callback# task: Retrieve the memory information from the VM
value:
  description: Retrieve the memory information from the VM
  returned: On success
  sample:
    hot_add_enabled: 1
    size_MiB: 1024
