...
short_description: Returns information about a virtual CD-ROM device.
...
"""
RETURN = r"""
# content generated by the update_return_section callback# task: List the cdrom devices on the guest
value:
  description: List the cdrom devices on the guest
  returned: On success
  sample: []
  type: list
"""
...
def build_url(params):
    ...
    if params.get("cdrom"):
        ...
        return yarl.URL(
            (
                "https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/hardware/cdrom/"
            ).format(**params)
            + params["cdrom"]
    ...
    return yarl.URL(
        ("https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/hardware/cdrom").format(
            **params
        )
        + gen_args(params, _in_query_parameters),
        encoded=True,
