...
short_description: Get storage health.
...
"""
RETURN = r"""
# content generated by the update_return_section callback# task: Get the health of the storage system
value:
  description: Get the health of the storage system
  returned: On success
  sample: green
  type: str
"""
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/api/appliance/health/storage").format(
        **params
    )
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/api/appliance/health/storage").format(
        **params
