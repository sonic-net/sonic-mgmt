...
DOCUMENTATION = r"""
module: appliance_access_shell_info
short_description: Get enabled state of BASH, that is, access to BASH from within
    the controlled CLI.
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/api/appliance/access/shell").format(**params)
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/api/appliance/access/shell").format(
        **params
