...
"""
RETURN = r"""
# content generated by the update_return_section callback# task: Get information about the vm-tools
value:
  description: Get information about the vm-tools
  returned: On success
  sample:
    is_connected: 0
  type: dict
...
def build_url(params):
    return ("https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/tools/installer").format(
        **params
    )
...
async def _info(params, session):
    ...
    _url = ("https://{vcenter_hostname}" "/api/vcenter/vm/{vm}/tools/installer").format(
        **params
