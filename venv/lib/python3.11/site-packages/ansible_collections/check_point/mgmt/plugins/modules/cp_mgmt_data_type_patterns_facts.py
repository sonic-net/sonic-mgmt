...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_patterns_facts
short_description: Get data-type-patterns objects facts on Checkpoint over Web Services API
description:
  - Get data-type-patterns objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-patterns
  cp_mgmt_data_type_patterns_facts:
    name: pattern-obj

- name: show-data-types-patterns
  cp_mgmt_data_type_patterns_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "data-types-patterns"
