...
DOCUMENTATION = """
---
module: cp_mgmt_mobile_profile_facts
short_description: Get mobile-profile objects facts on Checkpoint over Web Services API
description:
  - Get mobile-profile objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-mobile-profile
  cp_mgmt_mobile_profile_facts:
    name: New Mobile Profile

- name: show-mobile-profiles
  cp_mgmt_mobile_profile_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "mobile-profiles"
