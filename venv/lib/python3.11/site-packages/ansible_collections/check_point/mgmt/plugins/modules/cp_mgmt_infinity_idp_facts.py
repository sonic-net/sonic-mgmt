...
DOCUMENTATION = """
---
module: cp_mgmt_infinity_idp_facts
short_description: Get Infinity Identity Provider objects facts from the Infinity Portal.
description:
  - Get Infinity Identity Provider objects facts from the Infinity Portal.
...
EXAMPLES = """
- name: show-infinity-idp
  cp_mgmt_infinity_idp_facts:
    name: infinityIdp1

- name: show-infinity-idps
  cp_mgmt_infinity_idp_facts:
"""
...
def main():
    ...
    api_call_object = "infinity-idp"
    api_call_object_plural_version = "infinity-idps"
