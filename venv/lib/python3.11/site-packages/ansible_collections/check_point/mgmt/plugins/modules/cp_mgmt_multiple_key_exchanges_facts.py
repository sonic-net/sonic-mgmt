...
DOCUMENTATION = """
---
module: cp_mgmt_multiple_key_exchanges_facts
short_description: Get multiple-key-exchanges objects facts on Checkpoint over Web Services API
description:
  - Get multiple-key-exchanges objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-multiple-key-exchanges
  cp_mgmt_multiple_key_exchanges_facts:
    name: Multiple Key Exchanges

- name: show-multiple-key-exchanges-objects
  cp_mgmt_multiple_key_exchanges_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "multiple-key-exchanges-objects"
