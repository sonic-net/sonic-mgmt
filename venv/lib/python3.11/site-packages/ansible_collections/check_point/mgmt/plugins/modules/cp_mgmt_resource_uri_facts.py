...
DOCUMENTATION = """
---
module: cp_mgmt_resource_uri_facts
short_description: Get resource-uri objects facts on Checkpoint over Web Services API
description:
  - Get resource-uri objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-uri
  cp_mgmt_resource_uri_facts:
    name: newUriResource

- name: show-resources-uri
  cp_mgmt_resource_uri_facts:
...
def main():
    ...
    api_call_object_plural_version = "resources-uri"
