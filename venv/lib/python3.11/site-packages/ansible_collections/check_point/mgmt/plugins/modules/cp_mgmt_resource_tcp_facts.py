...
DOCUMENTATION = """
---
module: cp_mgmt_resource_tcp_facts
short_description: Get resource-tcp objects facts on Checkpoint over Web Services API
description:
  - Get resource-tcp objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-tcp
  cp_mgmt_resource_tcp_facts:
    name: newTcpResource

- name: show-resources-tcp
  cp_mgmt_resource_tcp_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "resources-tcp"
