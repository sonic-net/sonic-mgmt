...
DOCUMENTATION = """
---
module: cp_mgmt_limit_facts
short_description: Get limit objects facts on Checkpoint over Web Services API
description:
  - Get limit objects facts on Checkpoint devices.
...
def main():
    ...
    api_call_object_plural_version = "limits"
