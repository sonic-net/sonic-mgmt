...
DOCUMENTATION = """
---
module: cp_mgmt_user_template
short_description: Manages user-template objects on Checkpoint over Web Services API
description:
  - Manages user-template objects on Checkpoint devices including creating, updating and removing objects.
...
EXAMPLES = """
- name: add-user-template
  cp_mgmt_user_template:
    expiration_by_global_properties: 'False'
    expiration_date: '2030-05-30'
    name: myusertemplate
    state: present

- name: set-user-template
  cp_mgmt_user_template:
    expiration_by_global_properties: 'True'
    name: myusertemplate
    state: present
...
def main():
    argument_spec = dict(
        ...
        expiration_by_global_properties=dict(type='bool'),
