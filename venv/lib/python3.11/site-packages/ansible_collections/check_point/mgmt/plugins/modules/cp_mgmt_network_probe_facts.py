...
DOCUMENTATION = """
---
module: cp_mgmt_network_probe_facts
short_description: Get network-probe objects facts on Checkpoint over Web Services API
description:
  - Get network-probe objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-network-probe
  cp_mgmt_network_probe_facts:
    name: probe_GW1

- name: show-network-probes
  cp_mgmt_network_probe_facts:
    limit: 50
    offset: 0
"""
...
def main():
    ...
    api_call_object_plural_version = "network-probes"
