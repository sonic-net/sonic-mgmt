...
DOCUMENTATION = """
---
module: cp_mgmt_voip_domain_mgcp_call_agent_facts
short_description: Get voip-domain-mgcp-call-agent objects facts on Checkpoint over Web Services API
description:
  - Get voip-domain-mgcp-call-agent objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-voip-domain-mgcp-call-agent
  cp_mgmt_voip_domain_mgcp_call_agent_facts:
    name: mgcp1

- name: show-voip-domain-mgcp-call-agents
  cp_mgmt_voip_domain_mgcp_call_agent_facts:
    limit: 5
    offset: 0
"""
...
def main():
    ...
    api_call_object_plural_version = "voip-domain-mgcp-call-agents"
