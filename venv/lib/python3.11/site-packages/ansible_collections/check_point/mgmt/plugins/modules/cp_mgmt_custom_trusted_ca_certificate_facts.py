...
DOCUMENTATION = """
---
module: cp_mgmt_custom_trusted_ca_certificate_facts
short_description: Retrieve existing custom trusted CA certificate objects facts on Checkpoint devices.
description:
  - Retrieve existing custom trusted CA certificate objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-custom-trusted-ca-certificate
  cp_mgmt_custom_trusted_ca_certificate_facts:
    name: MyCACert

- name: show-custom-trusted-ca-certificates
  cp_mgmt_custom_trusted_ca_certificate_facts:
"""
...
def main():
    ...
    api_call_object = "custom-trusted-ca-certificate"
    api_call_object_plural_version = "custom-trusted-ca-certificates"
