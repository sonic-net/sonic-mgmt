...
DOCUMENTATION = """
---
module: cp_mgmt_resource_ftp_facts
short_description: Get resource-ftp objects facts on Checkpoint over Web Services API
description:
  - Get resource-ftp objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-ftp
  cp_mgmt_resource_ftp_facts:
    name: newFtpResource

- name: show-resources-ftp
  cp_mgmt_resource_ftp_facts:
...
def main():
    ...
    api_call_object_plural_version = "resources-ftp"
