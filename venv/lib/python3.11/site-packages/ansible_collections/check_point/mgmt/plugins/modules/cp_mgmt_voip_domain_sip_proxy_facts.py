...
DOCUMENTATION = """
---
module: cp_mgmt_voip_domain_sip_proxy_facts
short_description: Get voip-domain-sip-proxy objects facts on Checkpoint over Web Services API
description:
  - Get voip-domain-sip-proxy objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-voip-domain-sip-proxy
  cp_mgmt_voip_domain_sip_proxy_facts:
    name: sip1

- name: show-voip-domain-sip-proxies
  cp_mgmt_voip_domain_sip_proxy_facts:
    limit: 5
    offset: 0
"""
...
def main():
    ...
    api_call_object_plural_version = "voip-domain-sip-proxies"
