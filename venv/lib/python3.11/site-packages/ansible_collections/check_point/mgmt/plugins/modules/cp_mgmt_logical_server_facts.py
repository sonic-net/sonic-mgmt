...
DOCUMENTATION = """
---
module: cp_mgmt_logical_server_facts
short_description: Get logical-server objects facts on Checkpoint over Web Services API
description:
  - Get logical-server objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-logical-server
  cp_mgmt_logical_server_facts:
    name: logicalServer1

- name: show-logical-servers
  cp_mgmt_logical_server_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "logical-servers"
