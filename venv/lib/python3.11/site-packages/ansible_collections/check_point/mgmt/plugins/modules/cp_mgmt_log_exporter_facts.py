...
DOCUMENTATION = """
---
module: cp_mgmt_log_exporter_facts
short_description: Get log-exporter objects facts on Checkpoint over Web Services API
description:
  - Get log-exporter objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-log-exporter
  cp_mgmt_log_exporter_facts:
    name: newLogExporter

- name: show-log-exporters
  cp_mgmt_log_exporter_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "log-exporters"
