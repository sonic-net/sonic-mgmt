...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_patterns
short_description: Manages data-type-patterns objects on Checkpoint over Web Services API
description:
...
EXAMPLES = """
- name: add-data-type-patterns
  cp_mgmt_data_type_patterns:
...
def main():
    argument_spec = dict(
        ...
        number_of_occurrences=dict(type='int'),
