...
DOCUMENTATION = """
---
module: cp_mgmt_resource_smtp_facts
short_description: Get resource-smtp objects facts on Checkpoint over Web Services API
description:
  - Get resource-smtp objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-smtp
  cp_mgmt_resource_smtp_facts:
    name: newSmtpResource

- name: show-resources-smtp
  cp_mgmt_resource_smtp_facts:
...
def main():
    ...
    api_call_object_plural_version = "resources-smtp"
