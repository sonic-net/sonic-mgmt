...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_file_group_facts
short_description: Get data-type-file-group objects facts on Checkpoint over Web Services API
description:
  - Get data-type-file-group objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-file-group
  cp_mgmt_data_type_file_group_facts:
    name: Archive

- name: show-data-type-file-groups
  cp_mgmt_data_type_file_group_facts:
"""
