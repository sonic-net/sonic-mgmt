...
DOCUMENTATION = """
---
module: cp_mgmt_resource_cifs_facts
short_description: Get resource-cifs objects facts on Checkpoint over Web Services API
description:
  - Get resource-cifs objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-cifs
  cp_mgmt_resource_cifs_facts:
    name: newCifsResource

- name: show-resources-cifs
  cp_mgmt_resource_cifs_facts:
...
def main():
    ...
    api_call_object_plural_version = "resources-cifs"
