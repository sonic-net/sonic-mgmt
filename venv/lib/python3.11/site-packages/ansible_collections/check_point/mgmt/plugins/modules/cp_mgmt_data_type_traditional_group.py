...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_traditional_group
short_description: Manages data-type-traditional-group objects on Checkpoint over Web Services API
description:
...
options:
  ...
  data_types:
    description:
      - List of data-types.If data matches any of the data types in the group, the data type group is matched.
...
- name: delete-data-type-traditional-group
  cp_mgmt_data_type_traditional_group:
    name: trad-group-obj
    state: absent
"""
...
def main():
    argument_spec = dict(
        ...
        data_types=dict(type='list', elements='str'),
