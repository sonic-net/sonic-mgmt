...
DOCUMENTATION = """
---
module: cp_mgmt_infinity_idp_object_facts
short_description: Retrieve users/groups/machines objects facts from the Identity Provider.
description:
  - Retrieve users/groups/machines objects facts from the Identity Provider.
...
EXAMPLES = """
- name: show-infinity-idp-object
  cp_mgmt_infinity_idp_object_facts:
    name: User1

- name: show-infinity-idp-objects
  cp_mgmt_infinity_idp_object_facts:
"""
...
def main():
    ...
    api_call_object = "infinity-idp-object"
    api_call_object_plural_version = "infinity-idp-objects"
