...
DOCUMENTATION = """
---
module: cp_mgmt_compliance_scan
short_description: Runs the Compliance Software Blade scan. The scan evaluates the configuration compliance with the relevant best practices.
description:
...
RETURN = """
cp_mgmt_compliance_scan:
  description: The checkpoint compliance-scan output.
  returned: always.
  type: dict
"""
