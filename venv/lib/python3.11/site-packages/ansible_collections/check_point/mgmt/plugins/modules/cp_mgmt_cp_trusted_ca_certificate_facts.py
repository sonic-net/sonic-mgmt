...
DOCUMENTATION = """
---
module: cp_mgmt_cp_trusted_ca_certificate_facts
short_description: Retrieve existing Check Point trusted CA certificate objects facts on Checkpoint devices..
description:
  - Retrieve existing Check Point trusted CA certificate objects facts on Checkpoint devices..
...
EXAMPLES = """
- name: show-cp-trusted-ca-certificate
  cp_mgmt_cp_trusted_ca_certificate_facts:
    name: CA_0090EA36_7A7C_42DF_93EE_CFE97D542FFB

- name: show-cp-trusted-ca-certificates
  cp_mgmt_cp_trusted_ca_certificate_facts:
"""
...
def main():
    ...
    api_call_object = "cp-trusted-ca-certificate"
    api_call_object_plural_version = "cp-trusted-ca-certificates"
