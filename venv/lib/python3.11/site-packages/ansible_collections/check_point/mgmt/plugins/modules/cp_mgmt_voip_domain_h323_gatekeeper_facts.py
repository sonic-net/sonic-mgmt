...
DOCUMENTATION = """
---
module: cp_mgmt_voip_domain_h323_gatekeeper_facts
short_description: Get voip-domain-h323-gatekeeper objects facts on Checkpoint over Web Services API
description:
  - Get voip-domain-h323-gatekeeper objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-voip-domain-h323-gatekeeper
  cp_mgmt_voip_domain_h323_gatekeeper_facts:
    name: vdhg1

- name: show-voip-domain-h323-gatekeepers
  cp_mgmt_voip_domain_h323_gatekeeper_facts:
    limit: 5
    offset: 0
"""
...
def main():
    ...
    api_call_object = "voip-domain-h323-gatekeeper"
    api_call_object_plural_version = "voip-domain-h323-gatekeepers"
