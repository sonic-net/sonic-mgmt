...
DOCUMENTATION = """
---
module: cp_mgmt_ldap_group_facts
short_description: Get ldap-group objects facts on Checkpoint over Web Services API
description:
  - Get ldap-group objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-ldap-group
  cp_mgmt_ldap_group_facts:
    name: TestLdapGroup

- name: show-ldap-groups
  cp_mgmt_ldap_group_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "ldap-groups"
