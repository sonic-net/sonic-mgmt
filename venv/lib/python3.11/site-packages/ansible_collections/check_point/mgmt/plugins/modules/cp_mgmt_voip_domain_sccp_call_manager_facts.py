...
DOCUMENTATION = """
---
module: cp_mgmt_voip_domain_sccp_call_manager_facts
short_description: Get voip-domain-sccp-call-manager objects facts on Checkpoint over Web Services API
description:
  - Get voip-domain-sccp-call-manager objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-voip-domain-sccp-call-manager
  cp_mgmt_voip_domain_sccp_call_manager_facts:
    name: sccp1

- name: show-voip-domain-sccp-call-managers
  cp_mgmt_voip_domain_sccp_call_manager_facts:
    limit: 5
    offset: 0
"""
...
def main():
    ...
    api_call_object_plural_version = "voip-domain-sccp-call-managers"
