...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_group
short_description: Manages data-type-group objects on Checkpoint over Web Services API
description:
...
options:
  ...
  file_type:
    description:
      - List of data-types-file-attributes objects. Identified by name or UID.
    type: list
    elements: str
  file_content:
    description:
      - List of Data Types, identified by name or UID. At least one must be matched.
    type: list
    elements: str
  tags:
    description:
...
def main():
    argument_spec = dict(
        ...
        file_type=dict(type='list', elements='str'),
        file_content=dict(type='list', elements='str'),
