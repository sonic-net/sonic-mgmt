...
DOCUMENTATION = """
---
module: cp_mgmt_identity_provider_facts
short_description: Get identity-provider objects facts on Checkpoint over Web Services API
description:
  - Get identity-provider objects facts on Checkpoint devices.
...
- name: show-identity-provider
  cp_mgmt_identity_provider_facts:
    name: TestIdp

- name: show-identity-providers
  cp_mgmt_identity_provider_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "identity-providers"
