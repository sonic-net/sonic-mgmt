...
DOCUMENTATION = """
---
module: cp_mgmt_resource_uri_for_qos_facts
short_description: Get resource-uri-for-qos objects facts on Checkpoint over Web Services API
description:
  - Get resource-uri-for-qos objects facts on Checkpoint devices.
...
options:
  ...
  details_level:
    description:
      - The level of detail for some rof the fields in the response can vary from showing only the UID value of the object to a fully detailed
...
EXAMPLES = """
- name: show-resource-uri-for-qos
  cp_mgmt_resource_uri_for_qos_facts:
    name: newUriForQosResource

- name: show-resources-uri-for-qos
  cp_mgmt_resource_uri_for_qos_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "resources-uri-for-qos"
