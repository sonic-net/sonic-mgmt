...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_compound_group_facts
short_description: Get data-type-compound-group objects facts on Checkpoint over Web Services API
description:
  - Get data-type-compound-group objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-compound-group
  cp_mgmt_data_type_compound_group_facts:
    name: compound-group-obj

- name: show-data-type-compound-groups
  cp_mgmt_data_type_compound_group_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "data-type-compound-groups"
