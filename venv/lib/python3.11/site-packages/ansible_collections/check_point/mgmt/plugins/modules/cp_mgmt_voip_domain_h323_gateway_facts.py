...
DOCUMENTATION = """
---
module: cp_mgmt_voip_domain_h323_gateway_facts
short_description: Get voip-domain-h323-gateway objects facts on Checkpoint over Web Services API
description:
  - Get voip-domain-h323-gateway objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-voip-domain-h323-gateway
  cp_mgmt_voip_domain_h323_gateway_facts:
    name: vdhgw1

- name: show-voip-domain-h323-gateways
  cp_mgmt_voip_domain_h323_gateway_facts:
    limit: 5
    offset: 0
"""
...
def main():
    ...
    api_call_object_plural_version = "voip-domain-h323-gateways"
