...
DOCUMENTATION = """
---
module: cp_mgmt_mobile_access_profile_rule_facts
short_description: Get mobile-access-profile-rule objects facts on Checkpoint over Web Services API
description:
  - Get mobile-access-profile-rule objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-mobile-access-profile-rule
  cp_mgmt_mobile_access_profile_rule_facts:
    name: Rule 1

- name: show-mobile-access-profile-rulebase
  cp_mgmt_mobile_access_profile_rule_facts:
