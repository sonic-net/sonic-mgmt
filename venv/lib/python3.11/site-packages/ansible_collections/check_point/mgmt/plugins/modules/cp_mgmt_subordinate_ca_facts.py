...
DOCUMENTATION = """
---
module: cp_mgmt_subordinate_ca_facts
short_description: Get subordinate-ca objects facts on Checkpoint over Web Services API
description:
  - Get subordinate-ca objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-subordinate-ca
  cp_mgmt_subordinate_ca_facts:
    name: TestSubordinateCa

- name: show-subordinate-cas
  cp_mgmt_subordinate_ca_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "subordinate-cas"
