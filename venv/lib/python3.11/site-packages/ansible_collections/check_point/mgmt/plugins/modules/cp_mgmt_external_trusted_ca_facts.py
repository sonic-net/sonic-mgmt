...
DOCUMENTATION = """
---
module: cp_mgmt_external_trusted_ca_facts
short_description: Get external-trusted-ca objects facts on Checkpoint over Web Services API
description:
  - Get external-trusted-ca objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-external-trusted-ca
  cp_mgmt_external_trusted_ca_facts:
    name: external_ca

- name: show-external-trusted-cas
  cp_mgmt_external_trusted_ca_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "external-trusted-cas"
