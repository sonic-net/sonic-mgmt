...
DOCUMENTATION = """
---
module: cp_mgmt_resource_mms_facts
short_description: Get resource-mms objects facts on Checkpoint over Web Services API
description:
  - Get resource-mms objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-resource-mms
  cp_mgmt_resource_mms_facts:
    name: newMmsResource

- name: show-resources-mms
  cp_mgmt_resource_mms_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "resources-mms"
