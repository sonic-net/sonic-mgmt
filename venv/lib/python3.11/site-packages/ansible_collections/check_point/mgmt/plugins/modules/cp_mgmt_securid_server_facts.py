...
DOCUMENTATION = """
---
module: cp_mgmt_securid_server_facts
short_description: Get securid-server objects facts on Checkpoint over Web Services API
description:
  - Get securid-server objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-securid-server
  cp_mgmt_securid_server_facts:
    name: TestSecurIdServer

- name: show-securid-servers
  cp_mgmt_securid_server_facts:
    details_level: full
    limit: 5
    offset: 0
...
def main():
    ...
    api_call_object_plural_version = "securid-servers"
