...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_weighted_keywords_facts
short_description: Get data-type-weighted-keywords objects facts on Checkpoint over Web Services API
description:
  - Get data-type-weighted-keywords objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-weighted-keywords
  cp_mgmt_data_type_weighted_keywords_facts:
    name: weighted-words-obj

- name: show-data-types-weighted-keywords
  cp_mgmt_data_type_weighted_keywords_facts:
    limit: 5
"""
...
def main():
    ...
    api_call_object_plural_version = "data-types-weighted-keywords"
