...
DOCUMENTATION = """
---
module: cp_mgmt_passcode_profile_facts
short_description: Get passcode-profile objects facts on Checkpoint over Web Services API
description:
  - Get passcode-profile objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-passcode-profile
  cp_mgmt_passcode_profile_facts:
    name: My App Passcode Policy

- name: show-passcode-profiles
  cp_mgmt_passcode_profile_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "passcode-profiles"
