...
DOCUMENTATION = """
---
module: cp_mgmt_opsec_trusted_ca_facts
short_description: Get opsec-trusted-ca objects facts on Checkpoint over Web Services API
description:
  - Get opsec-trusted-ca objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-opsec-trusted-ca
  cp_mgmt_opsec_trusted_ca_facts:
    name: opsec_ca

- name: show-opsec-trusted-cas
  cp_mgmt_opsec_trusted_ca_facts:
"""
...
def main():
    ...
    api_call_object_plural_version = "opsec-trusted-cas"
