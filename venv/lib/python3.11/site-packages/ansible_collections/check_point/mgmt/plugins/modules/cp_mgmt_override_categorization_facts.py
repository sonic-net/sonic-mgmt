...
DOCUMENTATION = """
---
module: cp_mgmt_override_categorization_facts
short_description: Get override-categorization objects facts on Checkpoint over Web Services API
description:
...
EXAMPLES = """
- name: show-override-categorization
  cp_mgmt_override_categorization_facts:
    url: newOverride

- name: show-override-categorizations
  cp_mgmt_override_categorization_facts:
...
def main():
    ...
    api_call_object_plural_version = "override-categorizations"
