...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_file_attributes_facts
short_description: Get data-type-file-attributes objects facts on Checkpoint over Web Services API
description:
  - Get data-type-file-attributes objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-file-attributes
  cp_mgmt_data_type_file_attributes_facts:
    name: file-attr-obj

- name: show-data-types-file-attributes
  cp_mgmt_data_type_file_attributes_facts:
    limit: 5
"""
...
def main():
    ...
    api_call_object = "data-type-file-attributes"
    api_call_object_plural_version = "data-types-file-attributes"
