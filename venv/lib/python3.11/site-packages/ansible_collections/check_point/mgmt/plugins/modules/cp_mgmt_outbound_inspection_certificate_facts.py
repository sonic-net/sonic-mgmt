...
DOCUMENTATION = """
---
module: cp_mgmt_outbound_inspection_certificate_facts
short_description: Get outbound-inspection-certificate objects facts on Checkpoint over Web Services API
description:
  - Get outbound-inspection-certificate objects facts on Checkpoint devices.
...
- name: show-outbound-inspection-certificate
  cp_mgmt_outbound_inspection_certificate_facts:
    name: OutboundCertificate

- name: show-outbound-inspection-certificates
  cp_mgmt_outbound_inspection_certificate_facts:
"""
...
def main():
    ...
    api_call_object = "outbound-inspection-certificate"
    api_call_object_plural_version = "outbound-inspection-certificates"
