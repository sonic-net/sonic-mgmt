...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_keywords
short_description: Manages data-type-keywords objects on Checkpoint over Web Services API
description:
...
options:
  ...
  data_match_threshold:
    description:
      - If set to all-keywords - the data will be matched to the rule only if all the words in the list appear in the data contents.
        When set to min-keywords any number of the words may appear according to configuration.
    type: str
    choices: ['all-keywords', 'min-keywords']
