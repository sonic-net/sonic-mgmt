...
DOCUMENTATION = """
---
module: cp_mgmt_data_type_keywords_facts
short_description: Get data-type-keywords objects facts on Checkpoint over Web Services API
description:
  - Get data-type-keywords objects facts on Checkpoint devices.
...
EXAMPLES = """
- name: show-data-type-keywords
  cp_mgmt_data_type_keywords_facts:
    name: keywords_obj

- name: show-data-types-keywords
  cp_mgmt_data_type_keywords_facts:
"""
...
def main():
    ...
    api_call_object = "data-type-keywords"
    api_call_object_plural_version = "data-types-keywords"
