...
class CiscoImcsId(object):
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="cisco_i_m_c",
            function="updates_the_cisco_i_m_c_configuration_for_a_catalyst_center_node",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="cisco_i_m_c",
            function="deletes_the_cisco_i_m_c_configuration_for_a_catalyst_center_node",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CiscoImcsId(self._task.args, dnac)
