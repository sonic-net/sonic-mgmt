...
DOCUMENTATION = r"""
---
module: site_kpi_summaries_top_nanalytics_info
short_description: Information module for Site Kpi Summaries
  Top Nanalytics
description:
  - Get all Site Kpi Summaries Top Nanalytics. - > Gets
...
EXAMPLES = r"""
---
- name: Get all Site Kpi Summaries Top Nanalytics
  cisco.dnac.site_kpi_summaries_top_nanalytics_info:
    dnac_host: "{{dnac_host}}"
