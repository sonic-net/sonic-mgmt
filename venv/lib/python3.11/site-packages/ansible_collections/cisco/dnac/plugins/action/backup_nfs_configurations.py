...
class BackupNfsConfigurations(object):
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(
            nfsPort=params.get("nfsPort"),
            nfsVersion=params.get("nfsVersion"),
    ...
    def create_params(self):
        new_object_params = {}
        new_object_params["nfsPort"] = self.new_object.get("nfsPort")
        new_object_params["nfsVersion"] = self.new_object.get("nfsVersion")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = BackupNfsConfigurations(self._task.args, dnac)
