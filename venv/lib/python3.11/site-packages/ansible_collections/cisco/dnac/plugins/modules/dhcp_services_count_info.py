...
short_description: Information module for Dhcp Services
  Count
description:
  - Get all Dhcp Services Count. - > Retrieves the total
    number of DHCP Services for given parameters. For
...
seealso:
  - name: Cisco DNA Center documentation for Devices
    ...
    description: Complete reference of the RetrievesTheTotalNumberOfDHCPServicesForGivenParameters
      API.
...
EXAMPLES = r"""
---
- name: Get all Dhcp Services Count
