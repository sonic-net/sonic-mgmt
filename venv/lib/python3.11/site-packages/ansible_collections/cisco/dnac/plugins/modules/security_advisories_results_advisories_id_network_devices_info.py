...
short_description: Information module for Security Advisories
  Results Advisories Id Network Devices
description:
  - Get all Security Advisories Results Advisories Id
    Network Devices.
  - Get security advisory network devices for the security
    advisory.
...
seealso:
  - name: Cisco DNA Center documentation for Compliance
      GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisory
    description: Complete reference of the GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisory
      API.
    link: https://developer.cisco.com/docs/dna-center/#!get-security-advisory-network-devices-for-the-security-advisory
notes:
  - SDK Method used are
    compliance.Compliance.get_security_advisory_network_devices_for_the_security_advisory,
  - Paths used are
