...
class ImagesSiteWiseProductNames(object):
    ...
    def create(self):
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="assign_network_device_product_name_to_the_given_software_image",
    ...
    def update(self):
        ...
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="update_the_list_of_sites_for_the_network_device_product_name_assigned_to_the_software_image",
    ...
    def delete(self):
        ...
        result = self.dnac.exec(
            family="software_image_management_swim",
            function="unassign_network_device_product_name_from_the_given_software_image",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ImagesSiteWiseProductNames(self._task.args, dnac)
