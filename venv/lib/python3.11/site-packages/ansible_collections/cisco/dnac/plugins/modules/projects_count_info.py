...
short_description: Information module for Projects Count
description:
...
seealso:
  - name: Cisco DNA Center documentation for Configuration
      Templates GetTemplateProjectCount
    description: Complete reference of the GetTemplateProjectCount
      API.
    link: https://developer.cisco.com/docs/dna-center/#!get-template-project-count
notes:
  - SDK Method used are
    configuration_templates.ConfigurationTemplates.get_template_project_count,
  - Paths used are
