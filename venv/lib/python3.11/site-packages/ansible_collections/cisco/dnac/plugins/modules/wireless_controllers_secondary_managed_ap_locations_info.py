...
short_description: Information module for Wireless Controllers
  Secondary Managed Ap Locations
description:
  - Get all Wireless Controllers Secondary Managed Ap
    Locations.
  - Retrieves all the details of Secondary Managed AP
...
seealso:
  - name: Cisco DNA Center documentation for Wireless
      GetSecondaryManagedAPLocationsForSpecificWirelessController
    description: Complete reference of the GetSecondaryManagedAPLocationsForSpecificWirelessController
      API.
...
EXAMPLES = r"""
---
- name: Get all Wireless Controllers Secondary Managed
    Ap Locations
