...
description:
  ...
  - Retrieves all the details of Anchor Managed AP locations
...
seealso:
  - name: Cisco DNA Center documentation for Wireless
      GetAnchorManagedAPLocationsForSpecificWirelessController
    description: Complete reference of the GetAnchorManagedAPLocationsForSpecificWirelessController
      API.
...
EXAMPLES = r"""
---
- name: Get all Wireless Controllers Anchor Managed
    Ap Locations
