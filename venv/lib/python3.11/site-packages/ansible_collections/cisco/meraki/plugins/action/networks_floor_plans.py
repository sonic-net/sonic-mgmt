...
required_if = [
    ("state", "present", ["floorPlanId", "name", "networkId"], True),
    ("state", "absent", ["floorPlanId", "name", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksFloorPlans(object):
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "floor_plan_id") or self.new_object.get("floorPlanId")
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="networks",
            function="updateNetworkFloorPlan",
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="networks",
            function="deleteNetworkFloorPlan",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksFloorPlans(self._task.args, meraki)
