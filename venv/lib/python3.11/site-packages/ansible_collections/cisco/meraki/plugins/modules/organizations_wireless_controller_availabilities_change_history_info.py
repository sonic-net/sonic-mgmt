...
EXAMPLES = r"""
- name: Get all organizations _wireless _controller _availabilities _change _history
  cisco.meraki.organizations_wireless_controller_availabilities_change_history_info:
