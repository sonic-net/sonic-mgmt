...
notes:
  - SDK Method used are
    cellular_gateway.CellularGateway.get_organization_cellular_gateway_esims_service_providers,
  - Paths used are
    get /organizations/{organizationId}/cellularGateway/esims/serviceProviders,
"""

EXAMPLES = r"""
- name: Get all organizations _cellular _gateway _esims _service _providers
  cisco.meraki.organizations_cellular_gateway_esims_service_providers_info:
