...
required_if = [
    ("state", "present", ["clientId", "networkId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksClientsPolicy(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        if self.new_object.get('devicePolicy') is not None or self.new_object.get('device_policy') is not None:
            new_object_params['devicePolicy'] = self.new_object.get('devicePolicy') or \
                self.new_object.get('device_policy')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="networks",
                function="getNetworkClientPolicy",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksClientsPolicy(self._task.args, meraki)
