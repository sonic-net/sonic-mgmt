...
argument_spec.update(dict(
    ...
    resolution=dict(type="int"),
    autoResolution=dict(type="bool"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("resolution") is not None:
            new_object["resolution"] = params.get(
                "resolution")
        if params.get("autoResolution") is not None:
            new_object["autoResolution"] = params.get(
                "autoResolution")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="wireless",
            function='getNetworkWirelessSignalQualityHistory',
