...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("networkIds") is not None:
            new_object["networkIds"] = params.get(
                "networkIds")
        if params.get("floorPlanIds") is not None:
            new_object["floorPlanIds"] = params.get(
                "floorPlanIds")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationFloorPlansAutoLocateStatuses',
