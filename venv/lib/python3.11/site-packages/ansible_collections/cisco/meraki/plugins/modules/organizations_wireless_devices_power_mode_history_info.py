...
notes:
  - SDK Method used are
    wireless.Wireless.get_organization_wireless_devices_power_mode_history,
  - Paths used are
    get /organizations/{organizationId}/wireless/devices/power/mode/history,
"""

EXAMPLES = r"""
- name: Get all organizations _wireless _devices _power _mode _history
  cisco.meraki.organizations_wireless_devices_power_mode_history_info:
