...
description:
  - Get all organizations _summary _top _devices _models _by _usage. - > Return metrics for organization's top 10 device models sorted by data
...
EXAMPLES = r"""
- name: Get all organizations _summary _top _devices _models _by _usage
