...
required_if = [
    ("state", "present", ["networkId", "portId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksAppliancePorts(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkAppliancePorts",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksAppliancePorts(self._task.args, meraki)
