...
class DevicesCellularGatewayPortForwardingRules(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getDeviceCellularGatewayPortForwardingRules",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="cellularGateway",
            function="updateDeviceCellularGatewayPortForwardingRules",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DevicesCellularGatewayPortForwardingRules(
