...
required_if = [
    ("state", "present", ["optInId", "organizationId"], True),
    ("state", "absent", ["optInId", "organizationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class OrganizationsEarlyAccessFeaturesOptIns(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                ...
                function="getOrganizationEarlyAccessFeaturesOptIns",
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get(
            "opt_in_id") or self.new_object.get("optInId")
    ...
    def delete(self):
        ...
        result = self.meraki.exec_meraki(
            family="organizations",
            function="deleteOrganizationEarlyAccessFeaturesOptIn",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = OrganizationsEarlyAccessFeaturesOptIns(self._task.args, meraki)
