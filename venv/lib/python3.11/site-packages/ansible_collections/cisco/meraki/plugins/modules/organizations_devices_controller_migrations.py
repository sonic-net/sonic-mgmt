...
DOCUMENTATION = r"""
module: organizations_devices_controller_migrations
short_description: Resource module for organizations _devices _controller _migrations
description:
  - Manage operation create of the resource organizations _devices _controller _migrations.
...
notes:
  - SDK Method used are
    organizations.Organizations.create_organization_devices_controller_migration,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_devices_controller_migrations:
