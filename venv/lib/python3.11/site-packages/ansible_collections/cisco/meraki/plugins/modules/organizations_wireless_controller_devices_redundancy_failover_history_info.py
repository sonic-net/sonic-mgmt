...
EXAMPLES = r"""
- name: Get all organizations _wireless _controller _devices _redundancy _failover _history
  cisco.meraki.organizations_wireless_controller_devices_redundancy_failover_history_info:
