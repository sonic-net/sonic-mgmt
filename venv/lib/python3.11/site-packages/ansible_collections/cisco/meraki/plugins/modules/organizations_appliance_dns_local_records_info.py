...
notes:
  - SDK Method used are
    appliance.Appliance.get_organization_appliance_dns_local_records,
  - Paths used are
    get /organizations/{organizationId}/appliance/dns/local/records,
"""

EXAMPLES = r"""
- name: Get all organizations _appliance _dns _local _records
  cisco.meraki.organizations_appliance_dns_local_records_info:
