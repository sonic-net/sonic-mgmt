...
notes:
  - SDK Method used are
    appliance.Appliance.get_organization_appliance_dns_split_profiles_assignments,
  - Paths used are
    get /organizations/{organizationId}/appliance/dns/split/profiles/assignments,
"""

EXAMPLES = r"""
- name: Get all organizations _appliance _dns _split _profiles _assignments
  cisco.meraki.organizations_appliance_dns_split_profiles_assignments_info:
