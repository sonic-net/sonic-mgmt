...
argument_spec.update(dict(
    ...
    campusGatewayClusterIds=dict(type="list"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("serials") is not None:
            new_object["serials"] = params.get(
                "serials")
        if params.get("campusGatewayClusterIds") is not None:
            new_object["campusGatewayClusterIds"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="wireless",
            function='getOrganizationWirelessClientsOverviewByDevice',
