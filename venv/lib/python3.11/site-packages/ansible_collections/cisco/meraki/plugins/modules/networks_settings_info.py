...
seealso:
  - name: Cisco Meraki documentation for networks getNetworkSettings
    description: Complete reference of the getNetworkSettings API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-network-settings
notes:
  - SDK Method used are
    networks.Networks.get_network_settings,
  - Paths used are
    get /networks/{networkId}/settings,
"""

EXAMPLES = r"""
- name: Get all networks _settings
