...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("monitoredMediaServerId") is not None:
            new_object["monitoredMediaServerId"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("monitoredMediaServerId")
        if id:
        ...
        if not id:
            response = meraki.exec_meraki(
                family="insight",
                function='getOrganizationInsightMonitoredMediaServers',
