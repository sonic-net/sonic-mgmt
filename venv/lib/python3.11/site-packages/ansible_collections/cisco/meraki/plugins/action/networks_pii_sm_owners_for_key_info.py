...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("username") is not None:
            new_object["username"] = params.get(
                "username")
        if params.get("email") is not None:
            new_object["email"] = params.get(
                "email")
        ...
        if params.get("serial") is not None:
            new_object["serial"] = params.get(
                "serial")
        if params.get("imei") is not None:
            new_object["imei"] = params.get(
                "imei")
        if params.get("bluetoothMac") is not None:
            new_object["bluetoothMac"] = params.get(
                "bluetoothMac")
