...
argument_spec.update(dict(
    ...
    globalBandwidthLimits=dict(type="dict"),
...
class NetworksApplianceTrafficShaping(object):
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(
            globalBandwidthLimits=params.get("globalBandwidthLimits"),
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="appliance",
                function="getNetworkApplianceTrafficShaping",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksApplianceTrafficShaping(self._task.args, meraki)
