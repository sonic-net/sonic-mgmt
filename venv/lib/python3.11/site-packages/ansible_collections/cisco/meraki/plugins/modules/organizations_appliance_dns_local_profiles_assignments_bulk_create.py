...
options:
  items:
    ...
    suboptions:
      network:
        description: The network attached to the profile.
        suboptions:
          id:
        ...
        type: dict
      profile:
        description: The profile the network is attached to.
        suboptions:
          id:
...
notes:
  - SDK Method used are
    appliance.Appliance.bulk_organization_appliance_dns_local_profiles_assignments_create,
  - Paths used are
...
EXAMPLES = r"""
- name: Create
  cisco.meraki.organizations_appliance_dns_local_profiles_assignments_bulk_create:
