...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("staticDelegatedPrefixId") is not None:
            new_object["staticDelegatedPrefixId"] = params.get(
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("staticDelegatedPrefixId")
        if id:
        ...
        if not id:
            response = meraki.exec_meraki(
                family="appliance",
                function='getNetworkAppliancePrefixesDelegatedStatics',
