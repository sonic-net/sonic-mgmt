...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("samlRoleId") is not None:
            new_object["samlRoleId"] = params.get(
                "samlRoleId")
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("samlRoleId")
        if id:
            response = meraki.exec_meraki(
                family="organizations",
                function='getOrganizationSamlRole',
        ...
        if not id:
            response = meraki.exec_meraki(
                family="organizations",
                function='getOrganizationSamlRoles',
