...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("accountIds") is not None:
            new_object["accountIds"] = params.get(
                "accountIds")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="cellular_gateway",
            function='getOrganizationCellularGatewayEsimsServiceProvidersAccountsRatePlans',
