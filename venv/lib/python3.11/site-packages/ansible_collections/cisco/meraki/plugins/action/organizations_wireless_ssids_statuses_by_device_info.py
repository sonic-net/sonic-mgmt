...
argument_spec.update(dict(
    ...
    bssids=dict(type="list"),
    hideDisabled=dict(type="bool"),
...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("serials") is not None:
            new_object["serials"] = params.get(
                "serials")
        if params.get("bssids") is not None:
            new_object["bssids"] = params.get(
                "bssids")
        if params.get("hideDisabled") is not None:
            new_object["hideDisabled"] = params.get(
                "hideDisabled")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            family="wireless",
            function='getOrganizationWirelessSsidsStatusesByDevice',
