...
short_description: Information module for networks _wireless _signal _quality _history
description:
  - Get all networks _wireless _signal _quality _history.
...
seealso:
  - name: Cisco Meraki documentation for wireless getNetworkWirelessSignalQualityHistory
    description: Complete reference of the getNetworkWirelessSignalQualityHistory API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-signal-quality-history
notes:
  - SDK Method used are
    wireless.Wireless.get_network_wireless_signal_quality_history,
  - Paths used are
    get /networks/{networkId}/wireless/signalQualityHistory,
"""

EXAMPLES = r"""
- name: Get all networks _wireless _signal _quality _history
