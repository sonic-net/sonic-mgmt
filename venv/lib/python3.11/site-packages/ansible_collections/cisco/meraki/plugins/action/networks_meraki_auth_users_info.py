...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        ...
        if params.get("networkId") is not None:
            new_object["networkId"] = params.get(
                "networkId")
        if params.get("merakiAuthUserId") is not None:
            new_object["merakiAuthUserId"] = params.get(
                "merakiAuthUserId")
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        id = self._task.args.get("merakiAuthUserId")
        if id:
            response = meraki.exec_meraki(
                family="networks",
                function='getNetworkMerakiAuthUser',
