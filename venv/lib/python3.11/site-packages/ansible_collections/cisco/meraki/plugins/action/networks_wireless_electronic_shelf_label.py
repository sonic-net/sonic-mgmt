...
class NetworksWirelessElectronicShelfLabel(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="wireless",
                function="getNetworkWirelessElectronicShelfLabel",
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(
            family="wireless",
            function="updateNetworkWirelessElectronicShelfLabel",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksWirelessElectronicShelfLabel(self._task.args, meraki)
