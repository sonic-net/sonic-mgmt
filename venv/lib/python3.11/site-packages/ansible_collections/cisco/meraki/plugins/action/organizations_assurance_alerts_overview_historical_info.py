...
class ActionModule(ActionBase):
    ...
    def get_all(self, params):
        ...
        if params.get("organizationId") is not None:
            new_object["organizationId"] = params.get(
                "organizationId")
        if params.get("segmentDuration") is not None:
            new_object["segmentDuration"] = params.get(
                "segmentDuration")
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = meraki.exec_meraki(
            ...
            function='getOrganizationAssuranceAlertsOverviewHistorical',
