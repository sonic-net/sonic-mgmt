...
class NetworksClientsSplashAuthorizationStatus(object):
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksClientsSplashAuthorizationStatus(self._task.args, meraki)
