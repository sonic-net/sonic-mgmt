...
description:
  - Get all organizations _devices _power _modules _statuses _by _device. - > List the most recent status information for power modules in rackmount
    MX and MS devices that support them. The data returned by this endpoint is updated every 5 minutes.
version_added: '1.0.0'
