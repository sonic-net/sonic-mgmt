...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco Meraki documentation for appliance getNetworkApplianceFirewallCellularFirewallRules
    description: Complete reference of the getNetworkApplianceFirewallCellularFirewallRules API.
    link: https://developer.cisco.com/meraki/api-v1/#!get-network-appliance-firewall-cellular-firewall-rules
notes:
  - SDK Method used are
    appliance.Appliance.get_network_appliance_firewall_cellular_firewall_rules,
  - Paths used are
