...
3. It publishes a Markdown report plus a machine-readable YAML artifact, and uses the JSON output to upsert results into a GitHub Project as draft issues/cards.
