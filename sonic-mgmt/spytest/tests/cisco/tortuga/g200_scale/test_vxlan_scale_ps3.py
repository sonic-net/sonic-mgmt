...
def get_dut_config_file(feature):
    ...
    if feature == 'vrf_scale_1_v6vtep_v6host':
        ...
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 1, "port2": 3}
        ...
        ixia_config = os.path.join(ixia_configs_dir, 'HW_ipv6_underlay_32_v4vtep_port24_PS3.ixncfg')
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 2, "port2": 3}

    elif feature == 'l2vni_scale_v6host':
        dut_config = 'l2vni_scale_dut_configs.yaml'
        ixia_config = os.path.join(ixia_configs_dir, 'HW_ipv6_underlay_32_v4vtep_v6hosts_port24_PS3.ixncfg')
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 2, "port2": 3}
        ...
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 3, "port2": 1}
        ...
        ixia_config = os.path.join(ixia_configs_dir, 'HW_ipv6_underlay_32_v4vtep_new_from_RAM_L3VNI_port24_PS3.ixncfg')
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 2, "port2": 3}

    elif feature == 'l3vni_scale_32v4vtep_v6hosts':
        dut_config = 'l3vni_32v4vtep_v6host_configs.yaml'
        ixia_config = os.path.join(ixia_configs_dir, 'HW_ipv6_underlay_32_v4vtep_v6hosts_new_from_RAM_L3VNI_port24_PS3.ixncfg')
        port_info = {"chassis_ip" : "10.29.157.50", "slot": 1, "port1": 2, "port2": 3}
...
def ixia_setup(ixia_config_file,port_info):
    ...
    # Check the condition 'Sessions Down' equal to 0
        ...
        protocolSummary.CheckCondition('Sessions Not Started', protocolSummary.EQUAL, 0, Timeout=180) # Lenny
        protocolSummary.CheckCondition('Sessions Down', protocolSummary.EQUAL, 0, Timeout=180) # Lenny
        ixnetwork.info(protocolSummary)
        st.log("Condition met: Sessions Down is 0")
        st.log("Condition met: Sessions Not Started is 0")
        st.wait(5) 
