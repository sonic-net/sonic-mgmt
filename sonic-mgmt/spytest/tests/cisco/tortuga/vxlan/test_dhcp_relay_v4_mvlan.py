...
##  <default Vrf>
##                    VLAN30             VLAN40:ETH44   192.168.40.100
##                    192.168.30.254/24  192.168.40.1/24
##
##  config dhcp_relay ipv4 helper add 10 192.168.20.100
##  config dhcp_relay ipv4 helper add 30 192.168.40.100
##
######################################################################
...
##                    192.168.10.254/24  192.168.20.1/24
##  
##  <Vrf36>           VLAN30             VLAN40:ETH44   192.168.40.100
##                    192.168.30.254/24  192.168.40.1/24
##
##  config dhcp_relay ipv4 helper add 10 192.168.20.100
##  config dhcp_relay ipv4 helper add 30 192.168.40.100
...
##                    192.168.10.254/24  192.168.20.1/24
##  
##  <Vrf44>           VLAN30             VLAN40:ETH44   192.168.40.100
##                    192.168.30.254/24  192.168.40.1/24
##
##  config dhcp_relay ipv4 helper add 10 192.168.20.100
##  config dhcp_relay ipv4 helper add 30 192.168.40.100
...
##
##  config dhcp_relay ipv4 helper add 10 192.168.20.100
##  config dhcp_relay ipv4 helper add 50 192.168.20.100
##
######################################################################
