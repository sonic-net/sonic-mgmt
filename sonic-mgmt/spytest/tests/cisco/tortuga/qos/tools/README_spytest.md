...
```bash
# Full automated run (upgrade + test + publish)
./spytest_run.py --yaml /path/to/gamut_2x2_qos.yaml --url <image_url>
...
./run_test.sh --yaml /path/to/gamut_2x2_qos.yaml test_congestion_ipv4.py
...
./spytest_run.py --yaml /path/to/gamut_2x2_qos.yaml --skip-upgrade --test test_congestion_ipv4.py
...
6. **Phase 4** — Publish results via `spytest_publish.py`
...
```bash
python3 to_dut.py --yaml /path/to/testbed.yaml --config-dir base_configs/gamut_2x2_configs
python3 to_dut.py --yaml /path/to/testbed.yaml --config-dir base_configs/gamut_2x2_configs --yes
```
