...
def portchannel_fallback_module_hooks(request):
    ...
    vars = st.ensure_min_topology("D4D5:4", "D4T1:1", "D5T1:1")

    data.dut1 = vars.D4
    data.dut2 = vars.D5
    data.members_dut1 = [vars.D4D5P1, vars.D4D5P2,vars.D4D5P3 ]
    data.members_dut2 = [vars.D4D5P1, vars.D4D5P2,vars.D4D5P3 ]
