...
def get_dut_config_file(feature):
    ...
    ###Select config files based on breakout configs###
    ###2x400G###
    if feature == 'dpb_subinterface_400G':
        dut_config = 'dpb_subinterface_2x400G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_vrf_400G":
        dut_config = 'dpb_vrf_2x400G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}
        ...
        dut_config = 'dpb_dhcp_2x400G.yaml'
        ixia_config = r'DHCP relay-working.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_portch_400G":
        dut_config = 'dpb_portchannel_2x400G.yaml'
        ixia_config = r'carib_carib_optics_l2_traffic-4UDP-bidirec-vlannew.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_mtu_400G":
        dut_config = 'dpb_mtu_2x400G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4_MTU1500.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    ###4x200G###

    elif feature == 'dpb_subinterface_200G':
        dut_config = 'dpb_subinterface_4x200G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_vrf_200G":
        dut_config = 'dpb_vrf_4x200G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_bfd_200G":
        dut_config = 'dpb_4x200G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_dhcp_200G":
        dut_config = 'dpb_dhcp_4x200G.yaml'
        ixia_config = r'DHCP relay-working.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_portch_200G":
        dut_config = 'dpb_portchannel_4x200G.yaml'
        ixia_config = r'carib_carib_optics_l2_traffic-4UDP-bidirec-vlannew.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_mtu_200G":
        dut_config = 'dpb_mtu_4x200G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4_MTU1500.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    ###8x100G###

    elif feature == 'dpb_subinterface_100G':
        dut_config = 'dpb_subinterface_8x100G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_vrf_100G":
        dut_config = 'dpb_vrf_8x100G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_bfd_100G":
        dut_config = 'dpb_8x100G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_dhcp_100G":
        dut_config = 'dpb_dhcp_8x100G.yaml'
        ixia_config = r'DHCP relay-working.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_portch_100G":
        dut_config = 'dpb_portchannel_8x100G.yaml'
        ixia_config = r'carib_carib_optics_l2_traffic-4UDP-bidirec-vlannew.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}

    elif feature =="dpb_mtu_100G":
        dut_config = 'dpb_mtu_8x100G.yaml'
        ixia_config = r'carib_carib_optics_l3_traffic_bidir_only25_1_to_25_4_MTU1500.ixncfg'
        port_info = {"chassis_ip" : tg_info['ip'], "server_ip" : tg_info['ix_server'], "slot": 1, "port1": np1, "port2": np2}
...
def ixia_setup(ixia_config_file,port_info):
    st.log("Starting ixia session")
    ixnetwork_session = SessionAssistant(IpAddress=port_info['server_ip'], UserName="admin", Password="admin")
    ixnetwork = ixnetwork_session.Ixnetwork
    st.log("Loading ixia config file : {}".format(ixia_config_file))
    ...
    st.log("Mapping ixia ports and taking ownership")
    portMap.Connect(ForceOwnership=True)
    st.wait(10)
    st.log("Start all protocols")
    ixnetwork.StartAllProtocols(Arg1='sync')
    st.wait(20)

    traffic_items = ixnetwork.Traffic.TrafficItem.find()
    st.log("Generate traffic items")
    for traffic_item in traffic_items:
        traffic_item.Generate()
    st.wait(5)
    st.log("Apply traffic items")
...
def ixia_setup_dhcp(ixia_config_file,port_info):
    ...
    st.log("Setting up dhcp traffic")
...
@pytest.fixture(scope="function")
def dpb_subinterface_200G_setup():
    config_files = get_dut_config_file('dpb_subinterface_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_vrf_200G_setup():
    config_files = get_dut_config_file('dpb_vrf_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_bfd_200G_setup():
    config_files = get_dut_config_file('dpb_bfd_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_portch_200G_setup():
    config_files = get_dut_config_file('dpb_portch_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_mtu_200G_setup():
    config_files = get_dut_config_file('dpb_mtu_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_dhcp_200G_setup():
    config_files = get_dut_config_file('dpb_dhcp_200G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup_dhcp(config_files[1],config_files[2])
...
###100G###
@pytest.fixture(scope="function")
def dpb_subinterface_100G_setup():
    config_files = get_dut_config_file('dpb_subinterface_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_vrf_100G_setup():
    config_files = get_dut_config_file('dpb_vrf_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_bfd_100G_setup():
    config_files = get_dut_config_file('dpb_bfd_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_portch_100G_setup():
    config_files = get_dut_config_file('dpb_portch_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_mtu_100G_setup():
    config_files = get_dut_config_file('dpb_mtu_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup(config_files[1],config_files[2])
...
@pytest.fixture(scope="function")
def dpb_dhcp_100G_setup():
    config_files = get_dut_config_file('dpb_dhcp_100G')
    updated_cfg_file = modify_config_file(config_files[0],vars)
    static_config_push(updated_cfg_file)
    get_config_out()
    out = ixia_setup_dhcp(config_files[1],config_files[2])
...
def test_dpb_subinterface_2x400G(dpb_subinterface_400G_setup):
...
@pytest.mark.fourhundred
def test_dpb_vrf_2x400G(dpb_vrf_400G_setup):
...
@pytest.mark.fourhundred
@pytest.mark.skip
def test_dpb_bfd_2x400G(dpb_bfd_400G_setup):
...
@pytest.mark.fourhundred
def test_dpb_portch_2x400G(dpb_portch_400G_setup):
...
@pytest.mark.fourhundred
def test_dpb_mtu_2x400G(dpb_mtu_400G_setup):
...
@pytest.mark.fourhundred
def test_dpb_dhcp_2x400G(dpb_dhcp_400G_setup):
    ...
    if flag:
        ...
        st.log("test_dpb_dhcp test failed")
        get_cli_out()
        st.report_fail("test_case_failed")
...
@pytest.mark.twohundred
def test_dpb_subinterface_4x200G(dpb_subinterface_200G_setup):
    ixnetwork = dpb_subinterface_200G_setup[0]
    ixnetwork_session = dpb_subinterface_200G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.twohundred
def test_dpb_vrf_4x200G(dpb_vrf_200G_setup):
    ixnetwork = dpb_vrf_200G_setup[0]
    ixnetwork_session = dpb_vrf_200G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.twohundred
@pytest.mark.skip
def test_dpb_bfd_4x200G(dpb_bfd_200G_setup):
    ixnetwork = dpb_bfd_200G_setup[0]
    ixnetwork_session = dpb_bfd_200G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.twohundred
def test_dpb_portch_4x200G(dpb_portch_200G_setup):
    ixnetwork = dpb_portch_200G_setup[0]
    ixnetwork_session = dpb_portch_200G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.twohundred
def test_dpb_mtu_4x200G(dpb_mtu_200G_setup):
    ixnetwork = dpb_mtu_200G_setup[0]
    ixnetwork_session = dpb_mtu_200G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.twohundred
def test_dpb_dhcp_4x200G(dpb_dhcp_200G_setup):
    ixnetwork, ixnetwork_session, flag = dpb_dhcp_200G_setup
    ixia_teardown(ixnetwork_session)
    st.log("dpb test passed")
    if flag:
        st.log("test_dpb_dhcp test passed")
...
###100G###
@pytest.mark.hundred
def test_dpb_subinterface_8x100G(dpb_subinterface_100G_setup):
    ixnetwork = dpb_subinterface_100G_setup[0]
    ixnetwork_session = dpb_subinterface_100G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.hundred
def test_dpb_vrf_8x100G(dpb_vrf_100G_setup):
    ixnetwork = dpb_vrf_100G_setup[0]
    ixnetwork_session = dpb_vrf_100G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.hundred
@pytest.mark.skip
def test_dpb_bfd_8x100G(dpb_bfd_100G_setup):
    ixnetwork = dpb_bfd_100G_setup[0]
    ixnetwork_session = dpb_bfd_100G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.hundred
def test_dpb_portch_8x100G(dpb_portch_100G_setup):
    ixnetwork = dpb_portch_100G_setup[0]
    ixnetwork_session = dpb_portch_100G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.hundred
def test_dpb_mtu_8x100G(dpb_mtu_100G_setup):
    ixnetwork = dpb_mtu_100G_setup[0]
    ixnetwork_session = dpb_mtu_100G_setup[1]
    start_stop_traffic(ixnetwork)
    stats = get_traffic_stats(ixnetwork_session)
    #check tx and rx packet count
    result = validate_traffic_stats(stats)
...
@pytest.mark.hundred
def test_dpb_dhcp_8x100G(dpb_dhcp_100G_setup):
    ixnetwork, ixnetwork_session, flag = dpb_dhcp_100G_setup
    ixia_teardown(ixnetwork_session)
    st.log("dpb test passed")
    if flag:
        st.log("test_dpb_dhcp test passed")
...
def unconfig(config_file):
    ...
    with open(dir_path + '/' + config_file) as f:
        ...
        for node, config in config_dict.items():
            ...
            st.log("Clearing QOS config")
            config_dut(node, 'sonic', 'sudo config qos clear')
