"""
PFCWD All-to-All (A2A) L3 Single-Node Test  -- T8

Mirrors snappi: tests/snappi_tests/pfcwd/test_pfcwd_a2a_with_snappi.py.

Topology / pattern:
    3 TGEN ports (P1, P2, P3) on a single DUT, IPv6 L3 routing.
...
Tests in this file:
    test_pfcwd_a2a_trigger     -- long XOFF storm on P3; PFCWD MUST detect
                                  & restore; P1<->P2 lossless MUST be loss-free.
    test_pfcwd_a2a_no_trigger  -- sub-threshold XOFF burst on P3; PFCWD
...
def _run_a2a(trigger_pfcwd):
    ...
    test_name = (
        "test_pfcwd_a2a_trigger" if trigger_pfcwd
        else "test_pfcwd_a2a_no_trigger"
    )
    ...
    st.banner(f"PFCWD A2A: trigger_pfcwd={trigger_pfcwd}")
