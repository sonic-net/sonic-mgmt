...
=======
                                      ...
                                      rate_pps=rate_pps)
>>>>>>> db416bdcc384dddcb3acc8f5763007814c845e82
...
class TestBGPRif(TestBGPCommon):
    ...
    def test_ft_bgp_v4_dyn_nbr(self):
        ...
        # Verify bgp neighbors
        result = st.poll_wait(bgpapi.verify_bgp_summary, 30, leaf_name, neighbor='*'+spine_ipv4, state='Established', shell='vtysh')
        if not result:
            bgplib.show_bgp_neighbors([leaf_name, spine_name], af='ipv4')
    ...
    def test_ft_bgp_v6_dyn_nbr(self):
        ...
        result = st.poll_wait(bgpapi.verify_bgp_summary, 30, leaf_name, family='ipv6', neighbor='*'+spine_ipv6, state='Established', shell='vtysh')
        if not result:
            bgplib.show_bgp_neighbors([leaf_name, spine_name], af='ipv6')
