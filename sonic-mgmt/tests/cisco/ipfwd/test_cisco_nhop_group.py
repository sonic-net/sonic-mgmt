...
class IPRoutes:
    ...
    def program_replace_routes(self):
        """
        Create a file with static ip route add commands, copy file
        to DUT and run it from DUT
        """
...
def test_nhop_group_member_count(duthost, tbinfo):
    ...
    if is_cisco_device(duthost) or is_marvell_teralynx_device(duthost):
...
def test_nhop_group_member_order_capability(duthost, tbinfo, ptfadapter, gather_facts,
    ...
    G200_asic_v2 = False
    if is_cisco_device(duthost):
        output = duthost.shell("show platform ver")
        if "25.3.3000" in output["stdout"]:
            G200_asic_v1 = True
        if "25.5.3000" in output["stdout"]:
            G200_asic_v2 = True
    ...
    gr2_asic_flow_map = {
                            0: 'c0:ff:ee:00:00:12', 1: 'c0:ff:ee:00:00:10',
                            2: 'c0:ff:ee:00:00:10', 3: 'c0:ff:ee:00:00:0b',
                            4: 'c0:ff:ee:00:00:12', 5: 'c0:ff:ee:00:00:0d',
                            6: 'c0:ff:ee:00:00:11', 7: 'c0:ff:ee:00:00:0e',
                            8: 'c0:ff:ee:00:00:0e', 9: 'c0:ff:ee:00:00:0b',
                            10: 'c0:ff:ee:00:00:10', 11: 'c0:ff:ee:00:00:11',
                            12: 'c0:ff:ee:00:00:10', 13: 'c0:ff:ee:00:00:0b',
                            14: 'c0:ff:ee:00:00:0c', 15: 'c0:ff:ee:00:00:12',
                            16: 'c0:ff:ee:00:00:0d', 17: 'c0:ff:ee:00:00:0d',
                            18: 'c0:ff:ee:00:00:0d', 19: 'c0:ff:ee:00:00:0f',
                            20: 'c0:ff:ee:00:00:11', 21: 'c0:ff:ee:00:00:12',
                            22: 'c0:ff:ee:00:00:0c', 23: 'c0:ff:ee:00:00:0e',
                            24: 'c0:ff:ee:00:00:0d', 25: 'c0:ff:ee:00:00:10',
                            26: 'c0:ff:ee:00:00:0b', 27: 'c0:ff:ee:00:00:0c',
                            28: 'c0:ff:ee:00:00:12', 29: 'c0:ff:ee:00:00:0f',
                            30: 'c0:ff:ee:00:00:10', 31: 'c0:ff:ee:00:00:0d',
                            32: 'c0:ff:ee:00:00:0f', 33: 'c0:ff:ee:00:00:11',
                            34: 'c0:ff:ee:00:00:10', 35: 'c0:ff:ee:00:00:0c',
                            36: 'c0:ff:ee:00:00:0d', 37: 'c0:ff:ee:00:00:0e',
                            38: 'c0:ff:ee:00:00:12', 39: 'c0:ff:ee:00:00:0d',
                            40: 'c0:ff:ee:00:00:0c', 41: 'c0:ff:ee:00:00:0d',
                            42: 'c0:ff:ee:00:00:0b', 43: 'c0:ff:ee:00:00:10',
                            44: 'c0:ff:ee:00:00:11', 45: 'c0:ff:ee:00:00:0e',
                            46: 'c0:ff:ee:00:00:10', 47: 'c0:ff:ee:00:00:0c',
                            48: 'c0:ff:ee:00:00:0f', 49: 'c0:ff:ee:00:00:0c'}
    
    gr2_asic_flow_map_202405c = {
                            0: 'c0:ff:ee:00:00:0b', 1: 'c0:ff:ee:00:00:0c',
                            2: 'c0:ff:ee:00:00:0b', 3: 'c0:ff:ee:00:00:0e',
                            4: 'c0:ff:ee:00:00:10', 5: 'c0:ff:ee:00:00:11',
                            6: 'c0:ff:ee:00:00:0d', 7: 'c0:ff:ee:00:00:0f',
                            8: 'c0:ff:ee:00:00:12', 9: 'c0:ff:ee:00:00:0e',
                            10: 'c0:ff:ee:00:00:12', 11: 'c0:ff:ee:00:00:0b',
                            12: 'c0:ff:ee:00:00:12', 13: 'c0:ff:ee:00:00:0d',
                            14: 'c0:ff:ee:00:00:10', 15: 'c0:ff:ee:00:00:0d',
                            16: 'c0:ff:ee:00:00:0c', 17: 'c0:ff:ee:00:00:0b',
                            18: 'c0:ff:ee:00:00:10', 19: 'c0:ff:ee:00:00:12',
                            20: 'c0:ff:ee:00:00:0e', 21: 'c0:ff:ee:00:00:0e',
                            22: 'c0:ff:ee:00:00:0c', 23: 'c0:ff:ee:00:00:0f',
                            24: 'c0:ff:ee:00:00:0e', 25: 'c0:ff:ee:00:00:0b',
                            26: 'c0:ff:ee:00:00:0f', 27: 'c0:ff:ee:00:00:12',
                            28: 'c0:ff:ee:00:00:0e', 29: 'c0:ff:ee:00:00:0e',
                            30: 'c0:ff:ee:00:00:10', 31: 'c0:ff:ee:00:00:12',
                            32: 'c0:ff:ee:00:00:0e', 33: 'c0:ff:ee:00:00:0d',
                            34: 'c0:ff:ee:00:00:0b', 35: 'c0:ff:ee:00:00:0e',
                            36: 'c0:ff:ee:00:00:0e', 37: 'c0:ff:ee:00:00:0e',
                            38: 'c0:ff:ee:00:00:0f', 39: 'c0:ff:ee:00:00:0f',
                            40: 'c0:ff:ee:00:00:11', 41: 'c0:ff:ee:00:00:0c',
                            42: 'c0:ff:ee:00:00:12', 43: 'c0:ff:ee:00:00:12',
                            44: 'c0:ff:ee:00:00:11', 45: 'c0:ff:ee:00:00:10',
                            46: 'c0:ff:ee:00:00:0b', 47: 'c0:ff:ee:00:00:0c',
                            48: 'c0:ff:ee:00:00:12', 49: 'c0:ff:ee:00:00:10'}
    
    gr2_asic_flow_map_202505 = {
                            0: 'c0:ff:ee:00:00:12', 1: 'c0:ff:ee:00:00:10',
                            2: 'c0:ff:ee:00:00:10', 3: 'c0:ff:ee:00:00:0b',
                            4: 'c0:ff:ee:00:00:12', 5: 'c0:ff:ee:00:00:0d',
                            6: 'c0:ff:ee:00:00:11', 7: 'c0:ff:ee:00:00:0e',
    ...
    SUPPORTED_ASIC_TO_NEXTHOP_SELECTED_MAP = {"gb": gb_asic_flow_map, "gblc": gb_asic_flow_map, "gr": gr_asic_flow_map,
                                              "gr2": gr2_asic_flow_map_202405c if G200_asic_v1 else gr2_asic_flow_map_202505 if G200_asic_v2 else gr2_asic_flow_map}
...
def test_nhop_member_combination(duthost, tbinfo):
    """
    Test next hop group resource count to be 1, with various combinations of nhops per prefixs being replaced 
    Steps:
    - Add test IP address to an active IP interface
    - Add static ARPs
    - The combination creates around 12K lines of config
    - Create a combinations of NextHop grouo with Nexthop IPs from 2 to 4 in different Combinations 
    - The test replaces with the unique next-hop groups, 
    - Check to create only one Nhop group eventually, even when there are different combinations of nexthops
    - check CRM resource Nhop group used count before and ater with a difference of 1
    - clean up
    """
    # Set of parameters for Cisco-8000 devices

    default_max_nhop_paths = 4
    polling_interval = 1
    sleep_time = 240
    sleep_time_sync_before = 120
    ...
    # create nexthop group combination 
    nhop = IPRoutes(duthost, asic)
    try:
        for i in range(2, default_max_nhop_paths+1):
            ip_indices = list(combinations(indices, i))
            for j, indx_list in zip(range(nhop_group_count), ip_indices):
                # get a list of unique group of next hop IPs
                ips = [arplist.ip_mac_list[x].ip for x in indx_list]

                #Generating single 192.168.0.2 prefix 
                ip_route = "{}/31".format(ip_prefix + (2))

                # add IP route with the next hop group created
                nhop.add_ip_route(ip_route, ips)

        nhop.program_replace_routes()
        # wait for routes to be synced and programmed
        time.sleep(sleep_time)
        crm_after = get_crm_info(duthost, asic)
