"""
Tests for the `show platform npu voq cgm_profile` PFC command in SONiC
to match the expected the WRED probability configuration
"""
import time
import logging
import pytest
...
def test_show_platform_npu_voq_cgm_profile(duthosts, enum_rand_one_per_hwsku_hostname, request):
    """
    @summary: Verify output of `show platform npu voq cgm_profile with wred_profile`
    """
