...
from junit_xml_parser import (parse_test_result, validate_junit_json_file,
...
def _run_script():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
python3 report_uploader.py tests/files -e TRACKING_ID#22
""",
    )
    parser.add_argument("path_list", metavar="path", nargs="+", type=str, help="list of file/directory to upload.")
    parser.add_argument("--db_name", "-dn", type=str, help="The Kusto DB to upload to.")
