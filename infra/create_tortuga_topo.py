...
def main():
    ...
    print("Ixia (1/1-1/4) ----> Leaf0(Ethernet2..5)")
    print("Ixia (1/5-1/8) ----> Leaf1(Ethernet2..5)")
    print("Leaf0 Ethernet0 ----> Spine0 Ethernet0")
    print("Leaf0 Ethernet1 ----> Spine1 Ethernet1")
    print("Leaf1 Ethernet0 ----> Spine1 Ethernet0")
    print("Leaf1 Ethernet1 ----> Spine0 Ethernet1")
    print("Sonic-Mgmt eth1 ----> Leaf0 Ethernet6")
    print("Sonic-Mgmt eth2 ----> Leaf1 Ethernet6")
    print("******************************************************************************************************************************************************************************\n")
