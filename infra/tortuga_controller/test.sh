...
PYVXR_SUBINFS="Vrf40000|*|Ethernet1_9|eth1|lo|2"
PYVXR_RELAYS="*"
PYVXR_BGPPEERS="*"
PYVXR_CHANNELS="*"
PYVXR_VRFS="*"
...
if [[ "${LAG}" == true ]]; then
  PYVXR_CHANNELS="PortChannel0|leaf0:Ethernet1_7#leaf0:Ethernet1_10|10|false|eth1#eth2"
  LENGTH=$(echo "${LEAF_PORTS}" | tr -cd , | wc -c)
  if [[ ${LENGTH} -gt 0 ]]; then
    PYVXR_CHANNELS="${PYVXR_CHANNELS},PortChannel10|leaf1:Ethernet1_7#leaf1:Ethernet1_10|10|false|eth1#eth2"
  fi
  if [[ ${LENGTH} -gt 1 ]]; then
    PYVXR_CHANNELS="${PYVXR_CHANNELS},PortChannel20|leaf2:Ethernet1_7#leaf2:Ethernet1_10|10|false|eth1#eth2"
  fi
fi
