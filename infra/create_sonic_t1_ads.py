...
def upload_t1_files(data):
    ...
    ftp_client.put('t1-spine.j2','sonic-mgmt/ansible/roles/eos/templates/t1-spine.j2')
    ftp_client.put('t1-tor.j2','sonic-mgmt/ansible/roles/eos/templates/t1-tor.j2')
    ftp_client.put('veos.yml','sonic-mgmt/ansible/roles/eos/tasks/veos.yml')
