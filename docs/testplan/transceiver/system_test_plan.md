...
| breakout_concurrent_startup_supported | boolean | False | O | transceivers | Whether to run the CMIS breakout subport concurrent recovery test for this transceiver. Should be True for any CMIS transceiver whose physical port is broken out into 2 or more logical subports. |
