...
nightly_pipeline_202012 = {
     1: 'vms20-t0-7050cx3-1.202012',
     2: 'vms20-t0-7050cx3-2.202012',
     3: 'vms24-dual-t0-7050-1.202012',
     4: 'vms24-dual-t0-7050-2.202012',
     5: 'vms21-dual-t0-7050-3.202012',
     6: 'vms7-t0-7260-1.202012',
     7: 'vms7-t0-7260-2.202012',
     8: 'vms24-t0-7260-2.202012',
     9: 'vms21-dual-t0-7260.202012',
    10: 'vms28-dual-t0-7260.202012',
    11: 'vms6-t0-7060.1.202012',
    12: 'vms6-t1-7060.202012',
    13: 'vms11-2-t0-2700-2-platform_tests.202012',
    14: 'vms21-t0-2700-non-platform_tests.202012',
    15: 'vms7-t0-4600c-2.202012',
    16: 'testbed-str2-7215-acs-1.202012',
    17: 'vms7-t0-s6100.202012',
    18: 'vms7-t0-s6100-4.202012',
    19: 'vms11-t0-on-4-s6000.202012',
    20: 'vms13-5-t1-s6000.202012',
    21: 'testbed-bjw-can-2700-1.202012',
    22: 'vms13-4-t0-s6000.202012',
    23: 'vms7-t0-dx010-4.202012',
    24: 'vms7-t0-dx010-5.202012',
    25: 'vms6-t0-7060.2.202012',
    26: 'vms12-t0-3800-platform_tests.202012',
    27: 'vms28-t0-4600c-03-platform_tests.202012',
    28: 'vms28-t0-4600c-04-non-platform_tests.202012',
    29: 'testbed-bjw-can-7050qx-2.1.202012',
    30: 'testbed-bjw-can-7050qx-2.2.202012',
    31: '8102-t1-vms21-1.202012',    
}

nightly_pipeline_202205 = {
     1: 'vms21-dual-t0-7050-3.202205',
     2: 'vms24-dual-t0-7050-2.202205',
     3: 'vms3-t1-dx010-1.202205',
     4: 'vms7-t0-dx010-4.202205',
     5: 'vms7-t0-dx010-5.202205',
     6: 'vms20-t1-dx010-6.202205',
     7: 'vms1-t1-2700-platform_tests.202205',
     8: 'testbed-bjw-can-2700-1.202205',
     9: 'vms28-t0-4600c-03-platform_tests.202205',
    10: 'vms28-t0-4600c-04-non-platform_tests.202205',
    11: 'vmsvc1-dual-t0-7050-1',
    12: 'vmsvc1-dual-t0-7050-2',
    13: 'vmsvc1-dual-t0-7050-2-regular',
    14: 'vms24-dual-t0-7050-1.202205',
    15: 'vms1-8-t1-2700.202205',
    16: 'vms11-2-t0-2700-2-platform_tests.202205',
    17: 'vms21-t0-2700-non-platform_tests.202205',
    18: 'vms21-t1-2700-2-non-platform_tests.202205',
    19: 'vms18-t1-msn4600c-acs-1.202205',
    20: 'vms12-t0-3800-platform_tests.202205',
    21: 'vms20-t0-sn3800-2.202205',
    22: 'vms2-t1-7260-7.202205',
    23: 'vms20-t1-7050cx3-3-platform.202205',
    24: 'vms20-t1-7050cx3-3-non-platform.202205',
    25: 'vms7-t1-s6100-platform.202205',
    26: 'vms7-t1-s6100-non-platform.202205',   
}

nightly_pipeline_internal = {
     1: 'vms1-t1-2700-platform_tests.internal',
     2: 'vms11-2-t0-2700-2-platform_tests.internal',
     3: 'vms21-t1-2700-2-non-platform_tests.internal',
     4: 'vms21-t0-2700-non-platform_tests.internal',
     5: 'vms28-t0-4600c-03-platform_tests.internal',
     6: 'vms28-t0-4600c-04-non-platform_tests.internal',
     7: 'vms18-t1-msn4600c-acs-1.internal',
     8: 'vms7-t0-4600c-2.internal',
     9: 'vms12-t0-3800-platform_tests.internal',
    10: 'vms3-t1-dx010-1.internal',
    11: 'vms7-t0-dx010-4.internal',
    12: 'vms7-t0-dx010-5.internal',
    13: 'vms20-t1-dx010-6.internal',
    14: 'vms7-t0-s6100.internal',
    15: 'vms7-t0-s6100-4.internal',
    16: 'vms7-t1-s6100-platform.internal',
    17: 'vms7-t1-s6100-non-platform.internal',
    18: 'vms13-5-t1-s6000.internal',
    19: 'testbed-bjw-can-2700-1.internal',
    20: 'vms20-t0-7050cx3-1.internal',
    21: 'vms20-t0-7050cx3-2.internal',
    22: 'vms20-t1-7050cx3-3-platform.internal',
    23: 'vms20-t1-7050cx3-3-non-platform.internal',
    24: 'vms24-dual-t0-7050-1.internal',
    25: 'vms24-dual-t0-7050-2.internal',
    26: 'vms21-dual-t0-7050-3.internal',
    27: 'vms7-t0-7260-1.internal',
    28: 'vms7-t0-7260-2.internal',
    29: 'vms24-t0-7260-2.internal',
    30: 'vms21-dual-t0-7260.internal',
    31: 'vms28-dual-t0-7260.internal',
    32: 'vms2-t1-7260-7.internal',
    33: 'testbed-bjw-can-ec9516-1.internal',
    34: 'vms11-t0-on-4-s6000.internal',
    35: 'vms13-4-t0-s6000.internal',
}

nightly_pipeline_master = {
     1: 'vms20-t0-7050cx3-1.master',
     2: 'vms20-t0-7050cx3-2.master',
     3: 'vms20-t1-7050cx3-3-platform.master',
     4: 'vms20-t1-7050cx3-3-non-platform.master',
     5: 'vms21-dual-t0-7260.master',
     6: 'vms24-dual-t0-7050-1.master',
     7: 'vms28-dual-t0-7260.master',
     8: 'vms28-t0-7280-4.master',
     9: 'vms1-t1-2700-platform_tests.master',
    10: 'vms11-2-t0-2700-2-platform_tests.master',
    11: 'vms21-t0-2700-non-platform_tests.master',
    12: 'vms21-t1-2700-2-non-platform_tests.master',
    13: 'vms28-t0-4600c-03-platform_tests.master',
    14: 'vms28-t0-4600c-04-non-platform_tests.master',
    15: 'vms18-t1-msn4600c-acs-1.master',
    16: 'vms7-t0-4600c-2.master',
    17: 'vms12-t0-3800-platform_tests.master',
    18: 'vms3-t1-dx010-1.master',
    19: 'vms7-t0-dx010-4.master',
    20: 'vms7-t0-dx010-5.master',
    21: 'vms20-t1-dx010-6.master',
    22: 'vms21-t0-dx010-7.smoke',
    23: 'vms7-t0-s6100.master',
    24: 'vms7-t0-s6100-4.master',
    25: 'vms7-t1-s6100-platform.master',
    26: 'vms7-t1-s6100-non-platform.master',
    27: 'testbed-bjw-can-2700-1.master',
    28: 'vms21-dual-t0-7050-3.master',
    29: 'vms24-dual-t0-7050-2.master',
    30: 'vms2-t1-7260-7.master',
    31: 'vms24-t0-7260-2.master',
    32: 'vms7-t0-7260-2.master',    
}
