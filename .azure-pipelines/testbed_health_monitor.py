...
"""Script for monitoring testbed health.

    Example:
        ./testbed_health_monitor.py -t vms2-4-t0-2700 -i ../ansible/str --tbfile ../ansible/testbed.yaml -o testbed_health_monitor_result_vms2-4-t0-2700 --log-level info

    It will print the basic testbed monitor data result to the console, if you specify an output file, it will write to it as well.
    ...
    try:
        ...
        if output:
            with open(output, "w") as f:
                f.write(json.dumps(testbedMonitorResult.__dict__, indent=4))
                f.close()
