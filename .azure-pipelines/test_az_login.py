...
if __name__ == '__main__':
    ...
    cmd2 = "az login --identity --username e41c8a84-4662-48b0-b8a6-3f52230bcc5e"

    print(os.system(cmd2))

    cmd3 = 'az account get-access-token --resource {}'.format(os.environ.get("ELASTICTEST_MSAL_CLIENT_ID"))
