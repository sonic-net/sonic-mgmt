...
t0_run:
	echo "run T0 testing..."
	bash -c "cd infra; source pyats/bin/activate; python3.8 ./create_sonic_topo.py -f ../pyvxr_yaml_files/mth64_sonic_t0-64_topo.yaml -u cisco -p cisco123 -t t0-64 -c -r -s $(TESTFILE) -b http://172.29.93.10/sonic-images/golden-code/golden_code_churchill.tar.gz --cicd --cicd_clean --create_allure_report"
