...
def renew_mgmt_ip(dut, interface, **kwargs):
    ...
    if cli_type == "click":
        ...
        command = "renew dhcp-lease interface Management {}".format(interface.strip('eth'))
...
def exec_ssh_remote_dut(dut, ipaddress, username, password, command=None, timeout=30, **kwargs):
    ...
    exec_command = exec_command.format(password, timeout, username, ipaddress, command or "uptime")
