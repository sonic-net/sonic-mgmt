...
```
tar zxvf ./IxNetworkAPI11.00.2407.67Linux64.bin.tgz
cp ./IxNetworkAPI11.00.2407.67Linux64.bin ./sonic-mgmt/spytest/containers/keysight-ubuntu22/
```

# build container
```
docker build --no-cache --tag spytest/keysight-u22:latest ./sonic-mgmt/spytest/containers/keysight-ubuntu22
docker tag spytest/keysight-u22:latest spytest/keysight-u18:11.00.2407.67
```
