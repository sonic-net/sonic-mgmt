...
class IcosBaseConnection(CiscoBaseConnection):

    def __init__(self, **kwargs):
        if "altpassword" in kwargs:
            self.altpassword = kwargs["altpassword"]
            del kwargs["altpassword"]
        super(IcosBaseConnection, self).__init__(**kwargs)
    ...
    def session_preparation(self):
        ...
        if self.protocol == "ssh":
            ...
            return super(IcosBaseConnection, self).session_preparation()
    ...
    def set_base_prompt(self, pri_prompt_terminator='>',
        ...
        return super(IcosBaseConnection, self).set_base_prompt(
    ...
    def telnet_login(self, pri_prompt_terminator=r'#\s*$', alt_prompt_terminator=r'>\s*$',
        ...
        output = super(IcosBaseConnection, self).telnet_login(
    ...
    def read_channel(self):
        trace("============================== read_channel ============================")
        output = super(IcosBaseConnection, self).read_channel()
    ...
    def strip_ansi_escape_codes(self, string_buffer):
        rv = super(IcosBaseConnection, self).strip_ansi_escape_codes(string_buffer)
    ...
    def send_command(self, command_string, expect_string=None, delay_factor=1,
                     ...
                     use_genie=False):
        self.clear_cached_read_data()
        retval = super(IcosBaseConnection, self).send_command(command_string,
...
class IcosSshConnection(IcosBaseConnection):
    pass
