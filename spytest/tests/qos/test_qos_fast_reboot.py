...
def qos_fast_reboot_func_hooks(request):
...
def cos_config_verify():
    st.log("verifying cos config is present in running-config - FtFpSoQoSCoSCfg002")
...
def ipv4_acl_verify():
    st.log("Verfiying IPV4 ACL and rule present in running config - FtOpSoQosAclCmFn003")
...
def ipv6_acl_verify():
    st.log('Verifying IPv6 ACL and rule present in running config - FtOpSoQosAclCmFn004')
...
def wred_verify():
    st.log("verifying wred config in running config - FtOpSoQosWredCfg002")
...
def test_ft_qos_config_mgmt_verifying_config_with_save_fast_reboot():
    ...
    st.log("Checking for IPV4 ACL config after save and fast-reboot")
    ipv4_acl_verify()
    st.log("Checking for IPV6 ACL config after save and fast-reboot")
    ipv6_acl_verify()
    st.log("Checking for COS config after save and fast-reboot")
    cos_config_verify()
    st.log("Checking for wred config after save and fast-reboot")
    wred_verify()
    st.log("checking for ecn config after save and fast-reboot")
    ecn_verify()
