...
def start_arp_nd():
    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v4.get('1')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v4.get('2')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v4.get('3')['handle'], arp_target='all')

    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v6.get('1')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v6.get('2')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d1_p1_intf_v6.get('3')['handle'], arp_target='all')

    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v4.get('6')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v4.get('7')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v4.get('8')['handle'], arp_target='all')

    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v6.get('6')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v6.get('7')['handle'], arp_target='all')
    res = data.tg1.tg_arp_control(handle=data.d2_p1_intf_v6.get('8')['handle'], arp_target='all')
