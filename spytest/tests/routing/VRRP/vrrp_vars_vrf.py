...
vlan_list = get_random_sequence_list(list_length=vrrp_sessions+5)
...
vrrp_priority_list_dut1 = get_unique_random_list(1,101,253)
vrrp_priority_list_dut2 = get_unique_random_list(1,1,99)
