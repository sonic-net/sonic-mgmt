...
def post_test_l3_fwding():
    ...
    vlan_obj.show_vlan_config(dut1)
...
def test_l3_fwding():
    ...
    dut1 = vars.D1
    ip_obj.get_interface_ip_address(dut1, family="ipv4")
    ip_obj.get_interface_ip_address(dut1, family="ipv6")
    ip_obj.show_ip_route(dut1)
