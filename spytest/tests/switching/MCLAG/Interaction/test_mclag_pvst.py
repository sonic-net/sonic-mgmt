...
def test_ft_mclag_with_pvst_basic_tests():
    if lib_stp.lib_stp_mclag_basic_tests():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_orphan_port_shutdown():
    if lib_stp.lib_stp_mclag_orphan_port_shutdown():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_path_cost():
    if lib_stp.lib_stp_mclag_path_cost():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_rootbridge_multi_instances():
    if lib_stp.lib_stp_mclag_rootbridge_multi_instances():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_mclag_interface_shutdown():
    if lib_stp.lib_stp_mclag_interface_shutdown():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_stp_disable_enable():
    if lib_stp.lib_stp_mclag_disable_enable_stp():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_mclag_unconfig_config():
    if lib_stp.lib_stp_mclag_unconfig_config_mclag():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_failover_tests():
    if lib_stp.lib_stp_mclag_failover_tests():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_both_peers_reload():
    if lib_stp.lib_stp_mclag_both_peers_reload():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_config_reload():
    if lib_stp.lib_stp_mclag_config_reload():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_bpdu_guard():
    if lib_stp.lib_stp_mclag_bpdu_guard():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_port_fast():
    if lib_stp.lib_stp_mclag_port_fast():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_interaction_test():
    if lib_stp.lib_stp_mclag_pvst_and_rpvst_interaction():
       st.report_pass('test_case_passed')
    else:
       st.report_fail('test_case_failed')

def test_ft_mclag_with_pvst_peer_link_tests():
