...
def test_ft_mclag_with_rpvst_basic_tests_2_tier():
...
def test_ft_mclag_with_rpvst_mclag_unconfig_config_2_tier():
...
def test_ft_mclag_with_rpvst_both_peers_reload_2_tier():
