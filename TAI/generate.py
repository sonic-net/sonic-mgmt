...
Usage:
    ...
    python TAI/generate.py th7 --family tomahawk --parent core --hwsku NH-4030

    # Sub-generation (inherits previous gen)
    python TAI/generate.py th7c --family tomahawk --parent th7 --hwsku NH-4031

    # New family
    python TAI/generate.py q5d --family qumran2 --parent core --hwsku NH-6010
"""
