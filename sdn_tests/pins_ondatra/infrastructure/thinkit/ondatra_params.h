...
#ifndef PINS_INFRASTRUCTURE_THINKIT_ONDATRA_PARAMS_H_
#define PINS_INFRASTRUCTURE_THINKIT_ONDATRA_PARAMS_H_
...
#endif  // PINS_INFRASTRUCTURE_THINKIT_ONDATRA_PARAMS_H_
