...
def binding_deps():
    ...
    go_repository(
        ...
        version = "v1.0.0",
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/ghodss_yaml.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/ondatra.patch"],
        patch_args = ["-p1"],
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/snappi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/gnmi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/ygnmi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/gnoi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/gnoigo.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/gnsi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/gribi.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/ygot.patch"],
        patch_args = ["-p1"],
    )
    ...
    go_repository(
        ...
        patches = ["@com_github_pins_gpins_ondatra//:bazel/patches/ondatra/p4lang.patch"],
        patch_args = ["-p1"],
    )
