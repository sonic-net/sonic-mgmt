...
import (
	...
	"github.com/pins/gpins-ondatra/ondatra/binding/gpinsbind"
	"github.com/pins/gpins-ondatra/ondatra/pinstesthelper/pinstesthelper"
)
...
func TestGNMICPUName(t *testing.T) {
	...
	defer pinstesthelper.NewTearDownOptions(t).WithID("f9c713f4-3b1e-4a08-82ae-8c82746160a4").Teardown(t)
...
func TestGNMICPUType(t *testing.T) {
	// Report results in TestTracker at the end.
	defer pinstesthelper.NewTearDownOptions(t).WithID("4d8c458f-10cf-45eb-95d6-90911f05134a").Teardown(t)
...
func TestGNMICPURole(t *testing.T) {
	...
	defer pinstesthelper.NewTearDownOptions(t).WithID("202484be-ff32-4aa2-b459-da1a586b1476").Teardown(t)
