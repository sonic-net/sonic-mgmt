...
def pins_deps():
    ...
    if not native.existing_rule("com_github_grpc_grpc"):
        http_archive(
            ...
            patch_args = ["-p1"],
            patches = [
                "@com_github_pins_gpins_ondatra//:bazel/patches/grpc-001-fix_file_watcher_race_condition.patch",
                "@com_github_pins_gpins_ondatra//:bazel/patches/grpc-003-fix_go_gazelle_register_toolchain.patch",
            ],
        )
