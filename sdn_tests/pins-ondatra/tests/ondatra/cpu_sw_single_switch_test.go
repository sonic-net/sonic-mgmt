...
func TestGNMICPUParentPaths(t *testing.T) {
	...
	defer pinstesthelper.NewTearDownOptions(t).WithID("799e156c-0369-4969-b1f2-9c1197603131").Teardown(t)
...
func TestGNMICPUInDiscards(t *testing.T) {
	...
	defer pinstesthelper.NewTearDownOptions(t).WithID("c6e2ef27-d893-451b-9f65-db3e742780fd").Teardown(t)
	...
	for i = 1; i <= 5; i++ {
		...
		p4rtClient, err := pinstesthelper.FetchP4RTClient(t, dut, dut.RawAPIs().P4RT(t), nil)
		if err != nil {
