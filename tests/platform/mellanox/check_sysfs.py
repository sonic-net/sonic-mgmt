...
def check_sysfs(dut):
    ...
    for sfp_id in range(1, sfp_count + 1):
        sfp_temp_fault_file = "/var/run/hw-management/thermal/module{}_temp_fault".format(psu_id)
        ...
        sfp_temp_file = "/var/run/hw-management/thermal/module{}_temp_input".format(psu_id)
        ...
        sfp_temp_crit_file = "/var/run/hw-management/thermal/module{}_temp_crit".format(psu_id)
        ...
        sfp_temp_emergency_file = "/var/run/hw-management/thermal/module{}_temp_emergency".format(psu_id)
        ...
        if sfp_temp_crit != 0:
            assert sfp_temp < sfp_temp_crit, "sfp%d overheated, temp%s" % (psu_id, str(sfp_temp))
            assert sfp_temp_crit < sfp_temp_emergency, "wrong sfp critical temp or emergency temp, critical temp: %s emergency temp: %s" % (str(sfp_temp_crit), str(sfp_temp_emergency))
