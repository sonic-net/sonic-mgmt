...
def pytest_addoption(parser):
    ...
    parser.addoption("--save_uhd_config", action="store", help="Save UHD config mode")
    parser.addoption("--npu_dpu_startup", action="store", help="Startup NPU and DPUs and install configurations")
    parser.addoption("--l47_trafficgen", action="store", help="Enable L47 trafficgen config")
    parser.addoption("--save_l47_trafficgen", action="store", help="Save L47 trafficgen config")
