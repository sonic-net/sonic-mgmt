...
class MACFaultTest:
    ...
    def test_mac_remote_fault_increment(self, select_random_interface, fanouthosts):
        dut, interface = select_random_interface

        remote_host = fanouthosts[fanout]
        logging.info("DUT interface: {} connected to fanout switch: {} on port: {}".format(interface, fanout, fanout_port))
