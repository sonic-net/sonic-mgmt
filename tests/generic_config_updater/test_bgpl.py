...
def setup_env(duthosts, rand_one_dut_hostname, rand_asic_namespace):
    """
...
def test_bgpmon_tc1_add_and_remove(rand_selected_dut, bgpmon_setup_info, rand_asic_namespace):
