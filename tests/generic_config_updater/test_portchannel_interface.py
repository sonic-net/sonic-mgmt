...
def portchannel_interface_tc1_add_duplicate(duthost, portchannel_table, rand_asic_namespace, rand_portchannel_name):
...
def portchannel_interface_tc1_xfail(duthost, rand_asic_namespace, rand_portchannel_name):
...
def portchannel_interface_tc1_add_and_rm(duthost, portchannel_table, rand_asic_namespace, rand_portchannel_name):
    ...
    path_org_ip = (
        create_path([
            ...
            "PORTCHANNEL_INTERFACE", "{}|{}".format(rand_portchannel_name, org_ip)
        ])
    )
    path_org_ipv6 = (
        create_path([
...
def test_portchannel_interface_tc1_suite(rand_selected_dut, portchannel_table,
                                         rand_asic_namespace, rand_portchannel_name):
...
def portchannel_interface_tc2_replace(duthost, rand_asic_namespace, rand_portchannel_name):
    ...
    for attr, value in attributes:
        patch = {
            "op": "replace",
            "path": "{}/PORTCHANNEL/{}/{}".format(json_namespace, rand_portchannel_name, attr),
            "value": value
        }
...
def portchannel_interface_tc2_incremental(duthost, rand_asic_namespace, rand_portchannel_name):
    ...
    json_patch = [
        {
         "op": "add",
         "path": "{}/PORTCHANNEL/{}/description".format(json_namespace, rand_portchannel_name),
...
def test_portchannel_interface_tc2_attributes(rand_selected_dut, rand_asic_namespace, rand_portchannel_name):
    portchannel_interface_tc2_replace(rand_selected_dut, rand_asic_namespace, rand_portchannel_name)
    portchannel_interface_tc2_incremental(rand_selected_dut, rand_asic_namespace, rand_portchannel_name)
