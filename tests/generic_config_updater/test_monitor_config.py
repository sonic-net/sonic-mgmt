...
def get_valid_acl_ports(rand_selected_dut, rand_asic_namespace):
...
def bgp_monitor_config_cleanup(duthost, namespace=None):
    ...
    cmds.append('sonic-db-cli {} CONFIG_DB del "ACL_TABLE|{}"'.format(namespace_prefix, MONITOR_CONFIG_ACL_TABLE))
    ...
    cmds.append('sonic-db-cli {} CONFIG_DB del "POLICER|{}"'.format(namespace_prefix, MONITOR_CONFIG_POLICER))
...
def test_monitor_config_tc1_suite(rand_selected_dut, rand_asic_namespace, get_valid_acl_ports):
    ...
    monitor_config_add_config(rand_selected_dut, rand_asic_namespace, get_valid_acl_ports)
