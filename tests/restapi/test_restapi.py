...
def test_data_path(construct_url):
    ...
    logger.info("Adding Ethernet216 with tagging_mode: tagged to VLAN 2000")
    ...
    pytest_assert(r.json() == json.loads(expected))
    logger.info("Ethernet216 with tagging_mode: tagged has been successfully added to VLAN 2000")
    ...
    # Add and configure VLAN member
    params = '{"tagging_mode": "tagged"}'
    logger.info("Adding Ethernet220 with tagging_mode: tagged to VLAN 3000")
    ...
    pytest_assert(r.json() == json.loads(expected))
    logger.info("Ethernet220 with tagging_mode: tagged has been successfully added to VLAN 3000")
