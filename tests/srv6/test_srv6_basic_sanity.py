...
def test_check_routes(duthosts, rand_one_dut_hostname, nbrhosts):
    ...
    check_routes(
        nbrhost,
        ["fd00:201:201:fff1:11::", "fd00:202:202:fff2:22::"],
        ["fc08::2", "fc06::2"],
        global_route,
        is_v6,
    )
...
#
def test_traffic_check_local_link_fail_case(
    tbinfo, duthosts, rand_one_dut_hostname, ptfhost, nbrhosts, ptfadapter
):
    ...
    turn_on_off_frr_debug(
        duthosts, rand_one_dut_hostname, nbrhosts, docker_filename, vm, True
    )
    #
    ...
    ret1 = wait_until(
        ...
        check_bgp_neighbors_func,
        pe3,
        ["2064:100::1d", "2064:200::1e", "fc06::2"],
    )
    ...
    #
    turn_on_off_frr_debug(
        duthosts, rand_one_dut_hostname, nbrhosts, docker_filename, vm, False
    )
    collect_frr_debugfile(
        duthosts, rand_one_dut_hostname, nbrhosts, docker_filename, vm
    )
...
#
def test_traffic_check_remote_igp_fail_case(
    tbinfo, duthosts, rand_one_dut_hostname, ptfhost, nbrhosts, ptfadapter
):
...
#
def test_traffic_check_remote_bgp_fail_case(
    tbinfo, duthosts, rand_one_dut_hostname, ptfhost, nbrhosts, ptfadapter
):
