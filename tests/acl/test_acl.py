...
class BaseAclTest(six.with_metaclass(ABCMeta, object)):
    ...
    def test_source_ip_match_forwarded(self, setup, direction, ptfadapter,
                                       counters_sanity_check, ip_version, asic_db_dut, skip_traffic_test):   # noqa F811
        ...
        acl_entry = asic_db_dut.find_acl_by(src_ip=src_ip, packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_entry != []
    ...
    def test_rules_priority_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(src_ip=src_ip, packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
        acl_drop_entry = asic_db_dut.find_acl_by(src_ip=src_ip, packet_action='SAI_PACKET_ACTION_DROP')
    ...
    def test_dest_ip_match_forwarded(self, setup, direction, ptfadapter,
                                     counters_sanity_check, ip_version, vlan_name, asic_db_dut, skip_traffic_test):  # noqa F811
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(dst_ip=dst_ip, packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_dest_ip_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(dst_ip=dst_ip, packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_l4_dport_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(l4_dst_port=str(dst_port), packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_l4_sport_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(l4_src_port=str(src_port), packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_l4_dport_range_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(range_type='l4_dst_port', l4_dst_port=str(dport),
    ...
    def test_l4_sport_range_match_forwarded(self, setup, direction, ptfadapter,
        ...
        # verify ASIC DB has FORWARD rule for port in configured range
        acl_fwd_entry = asic_db_dut.find_acl_by(range_type='l4_src_port', l4_src_port=str(sport),
                                                packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_l4_dport_range_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(range_type='l4_dst_port', l4_dst_port=str(dport),
    ...
    def test_l4_sport_range_match_dropped(self, setup, direction, ptfadapter,
        ...
        # verify ASIC DB has DROP rule for port in configured range
        acl_drop_entry = asic_db_dut.find_acl_by(range_type='l4_src_port', l4_src_port=str(sport),
                                                 packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_ip_proto_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(ip_protocol=str(ip_protocol), packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_tcp_flags_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(tcp_flags=str(tcp_flags), packet_action='SAI_PACKET_ACTION_FORWARD')
        assert acl_fwd_entry != []
    ...
    def test_l4_dport_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(l4_dst_port=str(dst_port), packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_l4_sport_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(l4_src_port=str(src_port), packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_ip_proto_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(ip_protocol=str(ip_protocol), packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_tcp_flags_match_dropped(self, setup, direction, ptfadapter,
        ...
        acl_drop_entry = asic_db_dut.find_acl_by(tcp_flags=str(tcp_flags), packet_action='SAI_PACKET_ACTION_DROP')
        assert acl_drop_entry != []
    ...
    def test_icmp_match_forwarded(self, setup, direction, ptfadapter,
        ...
        acl_fwd_entry = asic_db_dut.find_acl_by(src_ip=src_ip, icmp_type=str(icmp_type),
