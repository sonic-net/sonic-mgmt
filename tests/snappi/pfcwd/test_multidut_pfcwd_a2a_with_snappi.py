...
from files.pfcwd_multidut_multi_node_helper import run_pfcwd_multi_node_test, dummy
...
def test_multidut_pfcwd_all_to_all(snappi_api,
                          conn_graph_facts,
                          fanout_graph_facts,
                          duthosts,
                          rand_select_two_dut,
    ...
    dummy(duthost1=duthost1,duthost12=duthost2)