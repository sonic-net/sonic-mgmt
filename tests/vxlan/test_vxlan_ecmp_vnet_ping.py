...
import json
import pytest
from tests.vxlan.vnet_monitor_utils import setup_info, setup_vnet_ping_responder, block_reply_for_vip, unblock_reply_for_vip # noqa F401
...
class Test_VxLAN_ECMP_Priority_endpoints():
    ...
    def dump_self_info_and_run_ptf(self,
        ...
        self.vxlan_test_setup['duthost'].shell_cmds(cmds=cmds)
    ...
    def test_vxlan_priority_multi_pri_sec_switchover(self, setUp, encap_type, setup_info, setup_vnet_ping_responder): # noqa F811
        '''
            tc1:create tunnel route 1 with 6 endpoints a = {A, B, A`, B`}. A,B
