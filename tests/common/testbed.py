...
class TestbedInfo(object):
    ...
    def _read_testbed_topo_from_csv(self):
        ...
        with open(self.testbed_filename) as f:
            ...
            topo = csv.DictReader(
                f, fieldnames=self.testbed_fields, delimiter=',')
    ...
    def parse_topo(self):
        for tb_name, tb in self.testbed_topo.items():
            ...
            tb['topo']['ptf_map_disabled'] = self.calculate_ptf_index_map_disabled(
                tb)
            tb['topo']['ptf_dut_intf_map'] = self.calculate_ptf_dut_intf_map(
                tb)
...
if __name__ == "__main__":
    ...
    file_group.add_argument(
        "-y", "--yaml", dest="testbed_yamlfile", help="testbed yaml file")
    file_group.add_argument(
        "-c", "--csv", dest="testbed_csvfile", help="testbed csv file")
    ...
    parser.add_argument(
        "--print-data", help="print testbed", action="store_true")
