...
def check_expiry_and_format_reason(mark_details, mark_name, test_path, skip_categories):
    ...
    Returns:
        tuple: (should_skip, formatted_reason, validation_errors)
    """
    validation_errors = []
    ...
    if not is_valid:
        ...
        return False, reason, validation_errors
    ...
    # If expired, modify behavior based on expiry_action
    if is_expired:
        ...
        if expiry_action == 'fail':
            ...
            return True, expired_reason, validation_errors
    ...
    return True, reason, validation_errors
