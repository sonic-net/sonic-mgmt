...
def dut_qos_maps(get_src_dst_asic_and_duts):
    ...
    try:
        ...
        maps['port_qos_map'] = json.loads(
            dut.shell("{} 'PORT_QOS_MAP'".format(sonic_cfggen_cmd))['stdout']
        )
        # dscp_to_tc_map
        maps['dscp_to_tc_map'] = json.loads(
            dut.shell("{} 'DSCP_TO_TC_MAP'".format(sonic_cfggen_cmd))['stdout']
        )
        # tc_to_queue_map
        maps['tc_to_queue_map'] = json.loads(
            dut.shell("{} 'TC_TO_QUEUE_MAP'".format(sonic_cfggen_cmd))['stdout']
        )
        # tc_to_priority_group_map
        maps['tc_to_priority_group_map'] = json.loads(
            dut.shell("{} 'TC_TO_PRIORITY_GROUP_MAP'".format(sonic_cfggen_cmd))['stdout']
        )
        # tc_to_dscp_map
        maps['tc_to_dscp_map'] = json.loads(
            dut.shell("{} 'TC_TO_DSCP_MAP'".format(sonic_cfggen_cmd))['stdout']
        )
