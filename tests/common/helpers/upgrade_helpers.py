...
def multi_hop_warm_upgrade_test_helper(duthost, localhost, ptfhost, tbinfo, get_advanced_reboot, upgrade_type, upgrade_path_urls,
                                       base_image_setup=None, pre_hop_setup=None, post_hop_teardown=None,
                                       multihop_advanceboot_loganalyzer_factory=None, enable_cpa=False):
    ...
    advancedReboot = get_advanced_reboot(rebootType=reboot_type)
    advancedReboot.runMultiHopRebootTestcase(upgrade_path_urls, base_image_setup=base_image_setup, pre_hop_setup=pre_hop_setup,
                        post_hop_teardown=post_hop_teardown, multihop_advanceboot_loganalyzer_factory=multihop_advanceboot_loganalyzer_factory)
