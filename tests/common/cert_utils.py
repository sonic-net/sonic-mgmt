...
class TlsCertificateGenerator:
    ...
    def generate_revoked_cert_with_crl(
        ...
        Writes three files to output_dir:
            gnmiclient.revoked.cer  – client cert with CRL CDP pointing to crl_distribution_url
            gnmiclient.revoked.key  – matching private key
            sonic.crl.pem           – CRL that lists the above cert as revoked
        """
