...
def test_ha_planned_shutdown(
    ...
    def primary_ha_action():
        ...
        set_dash_ha_scope(localhost, duthosts[0], ptfhost, "vdpu0_0:haset0_0", "dead", ha_owner)
    ...
    pytest_assert(
        activate_primary_dash_ha(
            localhost, duthosts[0], ptfhost, "vdpu0_0:haset0_0", "activate_role", owner=ha_owner),
    ...
    def standby_ha_action():
        ...
        set_dash_ha_scope(localhost, duthosts[1], ptfhost, "vdpu1_0:haset0_0", "dead", ha_owner)
    ...
    pytest_assert(
        activate_secondary_dash_ha(
            localhost, duthosts[1], ptfhost, "vdpu1_0:haset0_0", "activate_role", owner=ha_owner),
