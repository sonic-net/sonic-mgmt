...
The final local behavioral checks use mocked RPCs and device lifecycle. Physical
results and their transport limitations are recorded in the design document. Limits of
