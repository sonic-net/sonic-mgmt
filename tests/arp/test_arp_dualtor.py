...
def test_arp_update_for_failed_standby_neighbor(
    ...
    pytest_assert(wait_until(20, 5, 0, lambda: verify_neighbor_status(lower_tor_host, neighbor_ip, FAILED)))
    upper_tor_host.shell(ping_cmd, module_ignore_errors=True)
    pytest_assert(wait_until(20, 5, 0, lambda: verify_neighbor_status(upper_tor_host, neighbor_ip, REACHABLE)))
