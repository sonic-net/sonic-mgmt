...
FRAME_SIZE = [1024]
ECN_THRESHOLD = [1024*500]
OUTSTANDING_PACKETS = [10]
ITERATION_COUNT = 10
ECN_PMAX = 5.0

# This calculation is TBD 
EXPECTED_MIN_MARKRD_PACKETS = .05 * ITERATION_COUNT
EXPECTED_MAX_MARKRD_PACKETS = 1.0 * ITERATION_COUNT
...
def test_ecn_marking_at_ecress(api, 
    ...
    duthost.shell('sudo ecnconfig -p AZURE_LOSSLESS -gmax %s' %(ecn_thresholds * 4))
