...
class TestComponentApi(object):
    ...
    def test_get_name(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(name is not None, "Component {}: Unable to retrieve name".format(i))
            pytest_assert(isinstance(name, str), "Component {}: Name appears incorrect".format(i))
    ...
    def test_get_presence(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(presence is not None, "Component {}: Unable to retrieve presence".format(i))
            pytest_assert(isinstance(presence, bool), "Component {}: Presence appears incorrect".format(i))
            # All components are expected to be present on DuT
            pytest_assert(presence is True, "Component {} not present".format(i))
    ...
    def test_get_model(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(model is not None, "Component {}: Unable to retrieve model".format(i))
            pytest_assert(isinstance(model, str), "Component {}: Model appears incorrect".format(i))
    ...
    def test_get_serial(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(serial is not None, "Component {}: Unable to retrieve serial number".format(i))
            pytest_assert(isinstance(serial, str), "Component {}: Serial number appears incorrect".format(i))
    ...
    def test_get_status(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(status is not None, "Component {}: Unable to retrieve status".format(i))
            pytest_assert(isinstance(status, bool), "Component {}: Status appears incorrect".format(i))
    ...
    def test_get_description(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(description is not None, "Component {}: Failed to retrieve description".format(i))
            pytest_assert(isinstance(description, str), "Component {}: Description appears to be incorrect".format(i))
    ...
    def test_get_firmware_version(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            ...
            pytest_assert(fw_version is not None, "Component {}: Failed to retrieve firmware version".format(i))
            pytest_assert(isinstance(fw_version, str), "Component {}: Firmware version appears to be incorrect".format(i))
    ...
    def test_get_available_firmware_version(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            for image in range(image_list):
                ...
                pytest_assert(avail_fw_version is not None, "Component {}: Failed to retrieve available firmware version from image {}".format(i, image))
                pytest_assert(isinstance(avail_fw_version, str), "Component {}: Available Firmware version appears to be incorrect from image {}".format(i, image))
    ...
    def test_install_firmware(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            for image in range(image_list):
                ...
                pytest_assert(install_status is not None, "Component {}: Failed to install firmware from image {}".format(i, image))
                pytest_assert(isinstance(avail_fw_version, bool), "Component {}: Return of Firmware installation appears to be incorrect from image {}".format(i, image))
    ...
    def test_update_firmware(self, duthost, localhost, platform_api_conn):
        ...
        for i in range(self.num_components):
            for image in range(image_list):
                ...
                pytest_assert(update_status is not None, "Component {}: Failed to update firmware from image {}".format(i, image))
                pytest_assert(isinstance(update_status, bool), "Component {}: Return of Firmware update appears to be incorrect from image {}".format(i, image))
