    ...
    def test_get_position_in_parent(self, duthost, localhost, platform_api_conn):
        ...
        for j in range(self.num_psus):
            ...
            for i in range(num_fans):
                ...
                if self.expect(position is not None, "Unable to retrieve psu {} fan {} position".format(j, i)):
                    self.expect(isinstance(position, int), "psu {} fan {} position appears incorrect".format(j, i))
    ...
    def test_is_replaceable(self, duthost, localhost, platform_api_conn):
        ...
        for j in range(self.num_psus):
            ...
            for i in range(num_fans):
                ...
                if self.expect(replaceable is not None, "Unable to retrieve psu {} fan {} replaceable".format(j, i)):
                    self.expect(isinstance(replaceable, bool), "psu {} fan {} replaceable appears incorrect".format(j, i))
