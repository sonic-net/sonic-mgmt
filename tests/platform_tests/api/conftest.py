...
def start_platform_api_service(duthosts, enum_rand_one_per_hwsku_hostname, localhost):
...
def stop_platform_api_service(duthosts):
    try:
        ...
        for duthost in duthosts:
            ...
            out = \
            duthost.shell('docker exec pmon supervisorctl status platform_api_server', module_ignore_errors=True)[
                'stdout_lines']
