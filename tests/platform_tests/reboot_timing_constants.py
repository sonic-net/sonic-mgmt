...
OFFSET_ITEMS = ['DATABASE', 'PORT_INIT', 'PORT_READY', 'SYNCD_CREATE_SWITCH',
	'INIT_VIEW', 'SAI_CREATE_SWITCH', 'NEIGHBOR_ENTRY',
    'DEFAULT_ROUTE_SET', 'APPLY_VIEW', 'LAG_READY', 'FINALIZER']
