...
from tests.platform_tests.test_reboot import check_interfaces_and_services, reboot_and_check, set_max_time_for_interfaces
...
def test_power_off_reboot(duthosts, localhost, conn_graph_facts, enum_supervisor_dut_hostname,
