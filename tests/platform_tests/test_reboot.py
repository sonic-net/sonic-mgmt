...
def test_cold_reboot(duthosts, enum_rand_one_per_hwsku_hostname, localhost,
                     conn_graph_facts, set_max_time_for_interfaces, xcvr_skip_list):
    """
...
def test_watchdog_reboot(duthosts, enum_rand_one_per_hwsku_hostname, localhost,
                         set_max_time_for_interfaces, conn_graph_facts, xcvr_skip_list):
    """
...
def test_continuous_reboot(duthosts, enum_rand_one_per_hwsku_hostname, localhost,
                           set_max_time_for_interfaces, conn_graph_facts, xcvr_skip_list):
    """
