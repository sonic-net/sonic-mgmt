...
from files.helper import (
    run_bgp_peer_routing_policies_test, run_bgp_community_test,
    run_bgp_prefix_list_test, run_bgp_metric_filter,
    run_bgp_group_as_path_modified, run_bgp_origin_code_modification,
...
def test_bgp_peer_routing_policies(snappi_api,
                                   duthost,
                                   tgen_ports,
                                   conn_graph_facts,
                                   fanout_graph_facts,
    ...
    2) Generate 2 ipv4 routes & 2 ipv6 routes from TGEN1
       -- "200.1.0.0" & "4000::1" with Attributes
            ...
            d) Metric 50
       -- "20.1.0.0" & "6000::1"
    3) Create route policy in DUT to permit only "200.1.0.0"
    ...
    run_bgp_peer_routing_policies_test(snappi_api,
                                       duthost,
                                       tgen_ports)
...
# Test 3
@pytest.mark.topology("tgen")
def test_bgp_prefix_list_filter(snappi_api,
                                duthost,
                                tgen_ports,
                                conn_graph_facts,
                                fanout_graph_facts,
    ...
    run_bgp_prefix_list_test(snappi_api,
                             duthost,
                             tgen_ports)
...
# Test 4
@pytest.mark.topology("tgen")
def test_bgp_metric_filter(snappi_api,
                           duthost,
                           tgen_ports,
                           conn_graph_facts,
                           fanout_graph_facts,
    ...
    run_bgp_metric_filter(snappi_api,
                          duthost,
                          tgen_ports)
...
# Test 5
@pytest.mark.topology("tgen")
def test_bgp_group_as_path_modified(snappi_api,
                                    duthost,
                                    tgen_ports,
                                    conn_graph_facts,
                                    fanout_graph_facts,
    ...
    run_bgp_group_as_path_modified(snappi_api,
                                   duthost,
                                   tgen_ports)
...
# Test 6
@pytest.mark.topology("tgen")
def test_bgp_origin_code_modification(snappi_api,
                                      duthost,
                                      tgen_ports,
                                      conn_graph_facts,
                                      fanout_graph_facts,
    ...
    run_bgp_origin_code_modification(snappi_api,
                                     duthost,
                                     tgen_ports)