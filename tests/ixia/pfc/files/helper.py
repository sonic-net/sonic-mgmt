...
def __gen_traffic(testbed_config,
    ...
    for prio in test_flow_prio_list:
        ...
        test_flow.tx_rx.device.tx_names = tx_device_names
        test_flow.tx_rx.device.rx_names = rx_device_names
        ...
        test_flow.duration.fixed_seconds.delay = data_flow_delay_nanosec
        test_flow.duration.fixed_seconds.delay_unit = (
            test_flow.duration.fixed_seconds.NANOSECONDS)

    """ Background flows """
    for prio in bg_flow_prio_list:
        bg_flow = testbed_config.flows.flow(
            name='{} Prio {}'.format(bg_flow_name, prio))[-1]
        bg_flow.tx_rx.device.tx_names = tx_device_names
        bg_flow.tx_rx.device.rx_names = rx_device_names
        ...
        bg_flow.duration.fixed_seconds.delay = data_flow_delay_nanosec
        bg_flow.duration.fixed_seconds.delay_unit = (
            bg_flow.duration.fixed_seconds.NANOSECONDS)
    ...
    pause_flow.duration.continuous.delay = 0
    pause_flow.duration.continuous.delay_unit = (
        pause_flow.duration.continuous.NANOSECONDS
    )
