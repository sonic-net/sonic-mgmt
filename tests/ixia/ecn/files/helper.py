...
def __gen_traffic(testbed_config,
    ...
    data_flow.duration.fixed_packets.delay = data_flow_delay_nanosec
    data_flow.duration.fixed_packets.delay_unit = (
            data_flow.duration.fixed_packets.NANOSECONDS)
    ...
    pause_flow.duration.fixed_seconds.delay = 0
    pause_flow.duration.fixed_seconds.delay_unit = (
            pause_flow.duration.fixed_seconds.NANOSECONDS)
