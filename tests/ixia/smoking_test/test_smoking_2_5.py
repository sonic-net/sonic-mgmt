...
"""
Smoke test, 2.5. View device information
"""


def test_smoking_2_5(duthost):
    ###############################################################
    ...
    ###############################################################
    logger_msg(u'查看设备信息')
    ret = str(duthost.shell('show environment'))
    logger_msg(ret)

    ##############################################################
    #       STEP3: Determine whether the test case passes
    ##############################################################
    pytest_assert(result is True, 'Test case test_smoking_2_5 failed')
