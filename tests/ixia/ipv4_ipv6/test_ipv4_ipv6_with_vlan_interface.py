...
"""
IP4/IP6 basics
Configure multiple ipv4 and ipv6 addresses on the vlan interface at the same time
"""


def test_ipv4_ipv6_with_vlan_interface(ixiahost, testbed, duthost):
    ###############################################################
    ...
    result = True
    logging.basicConfig(filename=['ixia/test_ipv4_ipv6_with_vlan_interface.log'])
    ...
    duthost.shell('sudo config interface ip add Vlan2 11.1.1.2/24')
    duthost.shell('sudo config interface ip add Vlan2 11.1.2.2/24')
    duthost.shell('sudo config interface ip add Vlan2 11.1.3.2/24')
    duthost.shell('sudo config interface ip add Vlan2 2001:0:0:1::2/64')
    duthost.shell('sudo config interface ip add Vlan2 2001:0:0:2::2/64')
    duthost.shell('sudo config interface ip add Vlan2 2001:0:0:3::2/64')
    ...
    duthost.shell('sudo config interface ip remove Vlan2 11.1.1.2/24')
    duthost.shell('sudo config interface ip remove Vlan2 11.1.2.2/24')
    duthost.shell('sudo config interface ip remove Vlan2 11.1.3.2/24')
    duthost.shell('sudo config interface ip remove Vlan2 2001:0:0:1::2/64')
    duthost.shell('sudo config interface ip remove Vlan2 2001:0:0:2::2/64')
    duthost.shell('sudo config interface ip remove Vlan2 2001:0:0:3::2/64')
    ...
    ##############################################################
    pytest_assert(result is True, 'test_ipv4_ipv6_with_vlan_interface failed')
