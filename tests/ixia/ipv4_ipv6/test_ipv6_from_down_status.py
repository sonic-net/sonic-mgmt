...
"""
IP4/IP6 basics
Configure an ipv6 address on the Layer 3 interface in the down state, and then up
"""


def test_ipv6_from_down_status(ixiahost, testbed, duthost):
    ###############################################################
    ...
    ###############################################################
    #      STEP4: Interface startup, and configure ipv6 address
    ###############################################################

    logger_msg(u'Interface startup, and configure ipv6 address')
