...
def test_radv_deployment_id(duthost):
    ...
    assert ret == True, "radv container is not running"
    ...
    docker_cmd = 'docker exec radv sonic-cfggen -d -t /usr/share/sonic/templates/docker-router-advertiser.supervisord.conf.j2,/etc/supervisor/conf.d/supervisord.conf'
    ...
    assert ret == False, "radv service is still running"
