...
bgp_cmds = [
    ...
    re.compile(r"vtysh(\s+-Ec 'show bgp ip neighbors .* advertised-routes' -Ec 'show bgp ip neighbors .* routes')+"),
    re.compile(r"vtysh(\s+-Ec 'show bgp ipv6 neighbors .* advertised-routes' -Ec 'show bgp ipv6 neighbors .* routes')+"),
]
