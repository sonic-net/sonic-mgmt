...
def test_teamd_stress_restart(backup_and_restore_config, request,
    ...
    for iteration in range(restart_iterations):
        ...
        # Wait for all critical processes to stabilize after restart.
        # This ensures orchagent, syncd, bgp, etc. are fully initialized
        # before the next iteration or teardown config_reload.
        wait_critical_processes(duthost)
