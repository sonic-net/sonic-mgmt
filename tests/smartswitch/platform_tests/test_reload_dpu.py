...
def test_dpu_ping_after_reboot(duthosts, enum_rand_one_per_hwsku_hostname,
    ...
    ip_address_list, dpu_on_list, dpu_off_list = get_dpu_link_status(  # noqa: F405, E501
    ...
    check_dpu_link_and_status(duthost, dpu_on_list,  # noqa: F405
...
def test_kernel_panic_on_dpu(duthosts, enum_rand_one_per_hwsku_hostname,
    ...
    for index in range(num_dpu_modules):
        ...
        execute_dpu_commands(duthost,  # noqa: F405
                             ip_address,
                             kernel_panic_cmd,
                             output=False)
