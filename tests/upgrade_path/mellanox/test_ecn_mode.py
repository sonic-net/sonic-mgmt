...
from tests.upgrade_path.utilities import boot_into_base_image
...
class TestECNMode:
    ...
    def test_ecn_mode(self, rand_selected_dut, localhost, ptfadapter, tbinfo, restore_image):  # noqa: F811
        """
        ...
        if self.params['from_list']:
            ...
            with allure.step(f"Boot into base image {self.params['from_list']}"):
                boot_into_base_image(rand_selected_dut, localhost, self.params['from_list'], tbinfo)
