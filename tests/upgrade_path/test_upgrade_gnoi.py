...
def gnoi_upgrade_path_lists(request):
    ...
    return upgrade_type, from_list, image_url, restore_to_image, local_path, expected_to_version
...
def test_upgrade_via_gnoi(
    ...
    (upgrade_type, from_image, image_url, _restore_to_image, local_path, expected_to_version) = gnoi_upgrade_path_lists
