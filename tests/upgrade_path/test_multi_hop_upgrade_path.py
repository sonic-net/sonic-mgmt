...
from tests.platform_tests.conftest import xcvr_skip_list, dpu_npu_port_list                             # noqa F401
...
def test_multi_hop_upgrade_path(localhost, duthosts, rand_one_dut_hostname, ptfhost, tbinfo, request,
                                ...
                                verify_dut_health, consistency_checker_provider, xcvr_skip_list, dpu_npu_port_list):  # noqa F811
