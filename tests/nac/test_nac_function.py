...
def test_nac_functionality(ip_address1='172.30.25.82', username1='root', password1='admin123',
                           ip_address2='172.30.25.102', username2='admin', password2='YourPaSsWoRd',
                           ip_address3='172.30.25.93', username3='sonic', password3='admin123'):
    ...
    try:
        ...
        input = cmd_sup_ip
        print("Configuring IP on the Supplicant PC: " + input)
        ...
        cmd_show_int1 = stdout.read().decode()
        print(cmd_show_int1)
       ...
       print("Error connecting to the remote PC: {}".format(str(ssh_exception)))
    finally:
