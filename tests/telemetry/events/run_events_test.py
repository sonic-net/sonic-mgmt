...
from telemetry_utils import listen_for_event
logger = logging.getLogger(__name__)


def run_test(ptfhost, duthost, data_dir, validate_yang, trigger, json_file,
    ...
    # listen from cache
    listen_for_event(ptfhost, filter_event_regex, op_file)
    data = {}
