...
class TestMACFault(object):
    ...
    def test_mac_local_fault_increment(self, select_random_interface):
        ...
        logging.info("MAC local fault count after disabling/enabling rx-output using sfputil" +
    ...
    def test_mac_remote_fault_increment(self, select_random_interface):
        ...
        logging.info("MAC remote fault count after disabling/enabling rx-output using sfputil" +
