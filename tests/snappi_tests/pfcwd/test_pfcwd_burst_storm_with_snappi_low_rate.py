...
from tests.snappi_tests.pfcwd.files.pfcwd_burst_storm_low_rate_helper import run_pfcwd_burst_storm_low_rate_test

logger = logging.getLogger(__name__)
pytestmark = [pytest.mark.topology('tgen')]


def test_pfcwd_burst_storm_single_lossless_prio_low_rate(
    ...
    run_pfcwd_burst_storm_low_rate_test(
        api=snappi_api,
