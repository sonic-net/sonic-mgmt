...
from tests.snappi_tests.multidut.bgp.files.bgp_performance_helper import (
     run_bgp_route_install_test)                                                                    # noqa: F401
from tests.common.snappi_tests.snappi_test_params import SnappiTestParams                           # noqa: F401
from tests.snappi_tests.variables import t2_ports                                                   # noqa: F401
...
def test_bgp_route_install(cvg_api,                                     # noqa: F811
                            duthosts,
    ...
    snappi_extra_params.rx_port_count = rx_port_count
    ...
    pytest_assert(len(t2_ports) >= 3, "Need Minimum of 3 ports for this test")
    pytest_assert(rx_port_count < len(t2_ports), "Rx port count can't be equal/greater\
                  than total ports used in the test ")
