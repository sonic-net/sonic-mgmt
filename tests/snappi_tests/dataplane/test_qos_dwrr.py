...
from tests.snappi_tests.qos.files.qos_priority_helper import initiate_snappi_port_groups_dict, define_tx_rx_inter_port_testing, define_tx_rx_intra_port_testing, reload_dut, verify_dut_ports_up, read_dut_configs, create_snappi_flows_dwrr, run_traffic,  delete_flows, stop_traffic, map_scheduler_id_by_weight, verify_dwrr_pass_criteria
...
from tests.snappi_tests.dataplane.files.helper import get_duthost_interface_details, set_primary_chassis, create_snappi_config, create_snappi_config
...
class Common_vars:
    ...
    port_group_range = {}
    # {'sonic-s6100-dut1': {1: {'rx_ports': [], 'tx_ports': [], 'queue_id_list': [], 'dscp_tos_generator': {}, 'flows': []}, 3: 
    # {'rx_ports': [], 'tx_ports': [], 'queue_id_list': [], 'dscp_tos_generator': {}, 'flows': []}}}
    snappi_port_groups = {}
...
def execute_common_configs(rx_port_index, duthosts, create_snappi_config, snappi_api, snappi_extra_params, snappi_ports):
    ...
    control_state_obj = run_traffic(Common_vars, duthosts, snappi_api=snappi_api, config=Common_vars.snappi_configs)
...
def test_qos_dwrr_intra_port(snappi_api,                 # noqa F811
    ...
    for rx_port_index in range(Common_vars.total_rx_port_rotation):
        ...
        execute_common_configs(rx_port_index, duthosts, create_snappi_config, snappi_api, snappi_extra_params, snappi_ports)
