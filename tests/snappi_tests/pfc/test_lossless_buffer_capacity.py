...
def test_lossless_buffer_capacity(snappi_api,                      # noqa F811
    ...
    """
    Test if there is admission control at the ingress port for lossless traffic.
    We will only send lossless priority packets i.e. no background traffic, and
    block the egress port completely to ensure packets admitted stay under the
    ingress lossless buffer size.
