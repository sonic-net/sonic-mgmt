...
def save_test_results_to_file(test_func_name, test_data):
    """
    Save test results to JSON file in the /tmp directory.
    Noted that the file will not be saved if option '--save-timer-results' is not provided.
    Also, the file will be overwritten after each test run.
