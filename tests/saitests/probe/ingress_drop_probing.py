...
"""
IngressDropProbing - Ingress Drop Threshold Probing Test

Traffic Pattern: 1 src -> N dst
- Single source port sends to multiple destination ports
- Detects the Ingress Drop threshold by observing packet drops
...
class IngressDropProbing(ProbingBase):
    ...
    def get_expected_threshold(self):
        ...
        return (value, "Ingress Drop threshold") if value is not None else None
