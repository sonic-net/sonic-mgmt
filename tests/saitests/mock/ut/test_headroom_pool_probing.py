...
class TestHeadroomPoolProbingInstance:
    ...
    def __init__(self):
        ...
        self._UPPER_TABLE_MAPPING = {"lower_bound": None, "upper_bound": "value", "candidate_threshold": None, "range_step": None}
        self._LOWER_TABLE_MAPPING = {"lower_bound": "value", "upper_bound": "window_upper", "candidate_threshold": None, "range_step": None}
        self._RANGE_TABLE_MAPPING = {"lower_bound": "window_lower", "upper_bound": "window_upper", "candidate_threshold": "value", "range_step": "range_step"}
        self._POINT_TABLE_MAPPING = {"lower_bound": "window_lower", "upper_bound": "window_upper", "candidate_threshold": "value", "range_step": None}
...
class TestHeadroomPoolProbingResultBuilding(unittest.TestCase):
    ...
    def test_build_result_pool_exhausted(self):
        ...
        result = HeadroomPoolProbing._build_result(instance, pg_results, total_headroom, num_flows, exhaustion_threshold)
    ...
    def test_build_result_pool_not_exhausted(self):
        ...
        result = HeadroomPoolProbing._build_result(instance, pg_results, total_headroom, num_flows, exhaustion_threshold=1)
...
class TestHeadroomPoolProbingProbeMethod(unittest.TestCase):
    ...
    def test_probe_uses_pg_drop_counter_flag(self, mock_observer_class):
        ...
        ingress_drop_calls = [c for c in create_executor_calls if c['probe_target'] == 'ingress_drop']
        assert len(ingress_drop_calls) > 0
        for call in ingress_drop_calls:
            assert 'use_pg_drop_counter' in call['kwargs']
            assert call['kwargs']['use_pg_drop_counter'] is True
