...
from switch import (sai_thrift_read_port_counters,
                    port_list,
...
class CounterCollector:
    ...
    def __init__(self, ptftest, counter_name, port_ids=None):
        ...
        if 'dst' in self.ptftest.clients and self.ptftest.clients['src'] != self.ptftest.clients['dst']:
            ...
            self.port_ids = port_ids if port_ids is not None else list(flat_test_port_ids(ptftest.test_params.get('test_port_ids', None)))
