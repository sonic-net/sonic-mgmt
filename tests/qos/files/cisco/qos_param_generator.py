    ...
    def __define_shared_reservation_size(self):
        ...
        if self.is_large_sms:
            if self.is_deep_buffer:
                res_1 = {"dscps": [8, 8, 1, 1, 3, 4, 3, 4, 3, 4],
                        "pgs": [0, 0, 0, 0, 3, 4, 3, 4, 3, 4],
                        "queues": [0, 0, 1, 1, 3, 4, 3, 4, 3, 4],
                        "src_port_i": [0, 1, 0, 1, 0, 0, 1, 1, 2, 2],
                        "dst_port_i": [3, 3, 3, 3, 3, 3, 3, 3, 3, 3],
                        "pkt_counts": [10171, 10171, 10171, 10171, 3140, 6646, 6646, 1654, 1304, 1],
                        "shared_limit_bytes": 92274816}
                res_2 = {"dscps": [3, 4, 3, 4, 3, 4, 3, 4],
                        "pgs": [3, 4, 3, 4, 3, 4, 3, 4],
                        "queues": [3, 4, 3, 4, 3, 4, 3, 4],
                        "src_port_i": [0, 0, 1, 1, 2, 2, 3, 3],
                        "dst_port_i": [4, 4, 4, 4, 4, 4, 4, 4],
