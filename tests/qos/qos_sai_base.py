...
class QosSaiBase(QosBase):
    ...
    def copy_and_run_set_pir_script_cisco_8000(self, dut, port, asic="", speed="10000000"):
...
'''
    ...
    @pytest.fixture(scope="function", autouse=False)
    def set_pir_change(self, get_src_dst_asic_and_duts, dutConfig):
        dst_port = dutConfig['dutInterfaces'][dutConfig["testPorts"]["dst_port_id"]]
        dst_dut = get_src_dst_asic_and_duts['dst_dut']
        dst_asic = get_src_dst_asic_and_duts['dst_asic']
        dst_index = dst_asic.asic_index
        ...
        # Set scheduler to 5 Gbps.
        self.copy_and_run_set_pir_script_cisco_8000(
            dut=dst_dut, port=dst_port, asic=dst_index, speed=10*1000*1000)

        yield

        # Set scheduler back to original speed.
        self.copy_and_run_set_pir_script_cisco_8000(
            dut=dst_dut, port=dst_port, asic=dst_index, speed=int(port_speed))
