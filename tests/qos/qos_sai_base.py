    ...
    def __buildTestPorts(self, request, testPortIds, testPortIps, src_port_ids, dst_port_ids,
        ...
        if srcPorts is None:
            if src_port_ids:
                ...
                srcPorts = [1]
        if get_src_dst_asic_and_duts["src_asic"].sonichost.facts["hwsku"] in ["Cisco-8101-O8C48", "Cisco-8102-28FH-DPU-O-T1"]:
            ...
            for dut_asic in get_src_dst_asic_and_duts['all_asics']:
                ...
                for iface, addr in dut_asic.get_active_ip_interfaces(tbinfo).items():
                    ...
                    if (use_separated_upkink_dscp_tc_map or
                       (get_src_dst_asic_and_duts["src_asic"].sonichost.facts["hwsku"] in ["Cisco-8101-O8C48", "Cisco-8102-28FH-DPU-O-T1"])):
