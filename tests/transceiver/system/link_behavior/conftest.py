"""Link Behavior category conftest.
Opts the Link Behavior test category into the cross-category session-level
...
Link Behavior consumes the ``presence_verified, gold_fw_verified, links_verified`` gates.
"""
