...
def setup_init(testbed, duthost, duthost2, ptfhost, localhost):
    ...
    tp_facts = topo_facts.ParseTestbedTopoinfo().get_topo_config(testbed['topo'], "../ansible/")
    tp_facts_dut1 = topo_facts.ParseTestbedTopoinfo().get_topo_config(testbed['topo'] + "_dut1", "../ansible/")
    tp_facts_dut2 = topo_facts.ParseTestbedTopoinfo().get_topo_config(testbed['topo'] + "_dut2", "../ansible/")
