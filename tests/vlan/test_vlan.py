...
@pytest.mark.bsl
def test_vlan_tc1_send_untagged(ptfadapter, skip_sonic_leaf_fanout, work_vlan_ports_list, 
...
@pytest.mark.bsl
def test_vlan_tc2_send_tagged(ptfadapter, skip_sonic_leaf_fanout, work_vlan_ports_list, 
                              toggle_all_simulator_ports_to_rand_selected_tor_m):   # noqa F811
    """
    Test case #2
...
@pytest.mark.bsl
def test_vlan_tc4_tagged_unicast(ptfadapter, skip_sonic_leaf_fanout, work_vlan_ports_list, 
                                 vlan_intfs_dict, toggle_all_simulator_ports_to_rand_selected_tor_m):   # noqa F811
    """
    Test case #4
...
@pytest.mark.bsl
def test_vlan_tc6_tagged_untagged_unicast(ptfadapter, skip_sonic_leaf_fanout, work_vlan_ports_list, 
                                          vlan_intfs_dict, toggle_all_simulator_ports_to_rand_selected_tor_m):  # noqa F811
    """
    Test case #6
...
def test_vlan_tc7_tagged_qinq_switch_on_outer_tag(ptfadapter, skip_sonic_leaf_fanout, work_vlan_ports_list, vlan_intfs_dict,
                                                  duthost, toggle_all_simulator_ports_to_rand_selected_tor_m):  # noqa F811
    """
    Test case #7
